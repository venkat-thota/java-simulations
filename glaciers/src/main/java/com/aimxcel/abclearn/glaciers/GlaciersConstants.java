...
public class GlaciersConstants {
    ...
    public static final Font SUBPANEL_TITLE_FONT = new AimxcelFont( Font.BOLD, 12 );
    public static final Font SUBPANEL_CONTROL_FONT = new AimxcelFont( Font.PLAIN, 12 );
