...
import com.aimxcel.abclearn.glaciers.control.ScrollArrowNode;
import com.aimxcel.abclearn.glaciers.control.ScrollArrowNode.LeftScrollArrowNode;
import com.aimxcel.abclearn.glaciers.control.ScrollArrowNode.RightScrollArrowNode;
import com.aimxcel.abclearn.glaciers.model.*;
import com.aimxcel.abclearn.glaciers.model.IBoreholeProducer.IBoreholeProducerListener;
import com.aimxcel.abclearn.glaciers.model.IDebrisProducer.IDebrisProducerListener;
import com.aimxcel.abclearn.glaciers.model.IIceRippleProducer.IIceRippleProducerListener;
import com.aimxcel.abclearn.glaciers.model.IToolProducer.IToolProducerListener;
import com.aimxcel.abclearn.glaciers.model.Viewport.ViewportListener;
import com.aimxcel.abclearn.glaciers.view.tools.AbstractToolNode;
import com.aimxcel.abclearn.glaciers.view.tools.ToolNodeFactory;
import com.aimxcel.abclearn.glaciers.view.tools.ToolboxNode;
...
public class GlaciersPlayArea extends JPanel implements IToolProducerListener, IBoreholeProducerListener, IDebrisProducerListener, IIceRippleProducerListener, UnitsChangeListener {
    ...
    // View
    private final AimxcelPCanvas _birdsEyeCanvas, _zoomedCanvas;
    ...
    public GlaciersPlayArea( GlaciersModel model ) {
        ...
        // birds-eye view
        _birdsEyeCanvas = new AimxcelPCanvas();
        ...
        // zoomed view
        _zoomedCanvas = new AimxcelPCanvas();
    ...
    public AimxcelPCanvas getZoomedCanvas() {
