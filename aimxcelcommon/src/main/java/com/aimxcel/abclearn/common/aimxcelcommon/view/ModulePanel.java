...
/**
 * ModulePanel is the main JPanel for a Module in a AimxcelApplication.
...
public class ModulePanel extends JPanel {
    ...
    private void activateFullScreen() {
        ...
        if ( buttonDlg == null ) {
            ...
            buttonDlg.setTitle( AimxcelCommonResources.getInstance().getLocalizedString( "Common.BasicAimxcelPanel.Title" ) );
            buttonDlg.setDefaultCloseOperation( JDialog.DO_NOTHING_ON_CLOSE );
            ImageIcon logo = new ImageIcon( getClass().getClassLoader().getResource( AimxcelLookAndFeel.AIMXCEL_LOGO_120x50 ) );
            ...
            logoButton.setToolTipText( AimxcelCommonResources.getInstance().getLocalizedString( "Common.BasicAimxcelPanel.LogoToolTip" ) );
