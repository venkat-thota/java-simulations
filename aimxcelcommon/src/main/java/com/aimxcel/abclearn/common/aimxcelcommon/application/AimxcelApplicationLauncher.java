...
public class AimxcelApplicationLauncher {
    ...
    public static class ReflectionApplicationConstructor implements ApplicationConstructor {
        ...
        public AimxcelApplication getApplication( AimxcelApplicationConfig config ) {
            try {
                return (AimxcelApplication) abcLearnApplicationClass.getConstructor( new Class[] { config.getClass() } ).newInstance( new Object[] { config } );
            }
            catch ( Exception e ) {
    ...
    public void launchSim( final AimxcelApplicationConfig config, final Class abcLearnApplicationClass ) {
