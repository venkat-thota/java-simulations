...
public class DeploymentScenario {
    ...
    // enumeration
    public static final DeploymentScenario AIMXCEL_INSTALLATION = new DeploymentScenario( "phet-installation", true, true, true );
    public static final DeploymentScenario STANDALONE_JAR = new DeploymentScenario( "standalone-jar", true, true, true );
    public static final DeploymentScenario AIMXCEL_PRODUCTION_WEBSITE = new DeploymentScenario( "phet-production-website", false, false, false );
    public static final DeploymentScenario AIMXCEL_DEVELOPMENT_WEBSITE = new DeploymentScenario( "phet-development-website", false, false, false );
