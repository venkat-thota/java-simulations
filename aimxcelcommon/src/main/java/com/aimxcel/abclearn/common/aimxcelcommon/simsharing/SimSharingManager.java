...
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.SimSharingMessage.MessageType.model;
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.SimSharingMessage.MessageType.system;
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.SimSharingMessage.MessageType.user;
...
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.SystemActions.sentEvent;
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.SystemActions.started;
...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.SimSharingFileLogger;
...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.SimSharingPropertiesFile;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.components.SimSharingIdDialog;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.logs.ConsoleLog;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.logs.MongoLog;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.logs.StringLog;
...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.ModelMessage;
...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.SystemMessage;
...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.UserMessage;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.tests.MongoLoadTesterSimLauncher;
...
public class SimSharingManager {
    ...
    public static final SimSharingManager getInstance() {
        ...
        if ( INSTANCE == null ) {
            init( new AimxcelApplicationConfig( new String[]{}, "sim-sharing-manager" ) );
        }
    ...
    public static void init() {
        init( new AimxcelApplicationConfig( new String[]{"-study"}, "sim-sharing-manager" ) );
    }

    // Initialization, creates the singleton and sends startup events if sim-sharing is enabled.
    public static void init( final AimxcelApplicationConfig config ) {
        init( config, SIM_EVENT_COLLECTION_DB_NAME );
    }

    public static void init( final AimxcelApplicationConfig config, String dbName ) {
    ...
    private SimSharingManager( final AimxcelApplicationConfig applicationConfig, String dbName ) {
    ...
    */
    ...
    private void sendStartupMessage( AimxcelApplicationConfig config ) {
        assert ( enabled );
