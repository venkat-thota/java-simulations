...
public class AimxcelPreferences {
    ...
    */
    ...
    private void storePreferences() {
        if ( PREFERENCES_FILE != null ) {
            try {
                properties.store( new FileOutputStream( PREFERENCES_FILE ), "Preferences for PhET, see " + AimxcelCommonConstants.AIMXCEL_HOME_URL );
            }
            catch ( IOException e ) {
                e.printStackTrace();
            }
    ...
    public static void main( String[] args ) throws IOException {
        AimxcelPreferences phetPreferences = new AimxcelPreferences();
