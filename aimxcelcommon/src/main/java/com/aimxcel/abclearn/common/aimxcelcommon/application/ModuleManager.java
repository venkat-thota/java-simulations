...
class ModuleManager {
     ...
     */
    ModuleManager( AimxcelApplication abcLearnApplication ) {
    ...
    void addModule( Module module ) {
        ...
        modules.add( module );
        notifyModuleAdded( new ModuleEvent( getAbcLearnApplication(), module ) );
    }
    ...
    void removeModule( Module module ) {
        ...
        // Notifiy listeners
        notifyModuleRemoved( new ModuleEvent( getAbcLearnApplication(), module ) );
    }
    ...
    void setActiveModule( Module module ) {
        ...
        if ( activeModule != module ) {
            ...
            activate( module );
            notifyActiveModuleChanged( new ModuleEvent( getAbcLearnApplication(), module ) );
            verifyActiveState();
        }
    }
    ...
    private AimxcelApplication getAbcLearnApplication() {
