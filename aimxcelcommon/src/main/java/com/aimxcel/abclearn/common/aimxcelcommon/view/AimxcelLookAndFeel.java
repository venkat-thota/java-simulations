 ...
 * @version $Revision$
 */
public class AimxcelLookAndFeel {

    //----------------------------------------------------------------------------
    // Class data
    //----------------------------------------------------------------------------

    public static final String AIMXCEL_LOGO_120x50 = "logos/aimxcel-logo-120x50.jpg";
    ...
    private Font font = new AimxcelFont();
    private Font titledBorderFont = new AimxcelFont();
    private Font tabFont = new AimxcelFont();
    ...
    public void setFont( Font font ) {
        if ( font == null ) { font = new AimxcelFont(); }
    ...
    public void setTabFont( Font tabFont ) {
        if ( tabFont == null ) { tabFont = new AimxcelFont(); }
    ...
    public void setTitledBorderFont( Font borderFont ) {
        if ( titledBorderFont == null ) { titledBorderFont = new AimxcelFont(); }
    ...
    private Object getCommonString( String s ) {
        return AimxcelCommonResources.getInstance().getLocalizedString( s );
    }
...
// It should not be necessary to revalidate or repaint on top of that.
    ...
    protected String getLookAndFeelClassNamePreferOceanToWindows() {
        ...
        if ( AimxcelUtilities.getOperatingSystem() == AimxcelUtilities.OS_WINDOWS ) {
            if ( oldJava ) {
