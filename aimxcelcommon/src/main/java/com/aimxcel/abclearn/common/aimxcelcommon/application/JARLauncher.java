...
import com.aimxcel.abclearn.common.aimxcelcommon.application.JARLauncher;
    ...
    */
    ...
    private static String getTitle( Properties prop, String flavor ) {
        ...
        if ( new StringTokenizer( flavor, "_" ).countTokens() == 2 ) {
            ...
            AimxcelResources resources = new AimxcelResources( project );
    ...
    */
    ...
    private static void setLocaleForOfflineJARs( Properties properties ) {
        ...
        if ( language != null ) {
            ...
            if ( !language.equals( "" ) ) {
                System.out.println( "JARLauncher: setting " + AimxcelCommonConstants.PROPERTY_AIMXCEL_LANGUAGE + "=" + language );
                System.setProperty( AimxcelCommonConstants.PROPERTY_AIMXCEL_LANGUAGE, language );
                ...
                if ( country != null ) {
                    ...
                    if ( !country.equals( "" ) ) {
                        System.out.println( "JARLauncher: setting " + AimxcelCommonConstants.PROPERTY_AIMXCEL_COUNTRY + "=" + country );
                        System.setProperty( AimxcelCommonConstants.PROPERTY_AIMXCEL_COUNTRY, country );
                    }
                }
            }
        }
