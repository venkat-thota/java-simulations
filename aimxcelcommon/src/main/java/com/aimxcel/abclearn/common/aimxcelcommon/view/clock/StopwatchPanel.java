...
import com.aimxcel.abclearn.common.aimxcelcommon.view.clock.StopwatchPanel;
...
public class StopwatchPanel extends JPanel {
    ...
    public StopwatchPanel( IClock clock, String timeUnits, double scaleFactor, NumberFormat timeFormat ) {
        ...
        // Start/Stop button
        startString = AimxcelCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.start" );
        stopString = AimxcelCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.stop" );
        startStopButton = new JButton( startString );
        SwingUtils.fixButtonOpacity( startStopButton );

        // Reset button
        resetButton = new JButton( AimxcelCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.reset" ) );
