...
import com.aimxcel.abclearn.sound.view.ClockPanelLarge;
import com.aimxcel.abclearn.sound.view.MeasureControlPanel;
import com.aimxcel.abclearn.sound.view.MeterStickGraphic;
import com.aimxcel.abclearn.sound.view.VerticalGuideline;
...
public class SingleSourceMeasureModule extends SingleSourceModule {
     ...
     * @param application
     */
    protected SingleSourceMeasureModule( AimxcelApplication application ) {
        ...
        try {
            ...
            AimxcelImageGraphic ruler = new AimxcelImageGraphic( apparatusPanel, bi );
        ...
        // Stopwatch window
        stopwatchDlg = new JDialog( application.getAimxcelFrame(), "Stopwatch", false );
        ...
        stopwatchDlg.setLocationRelativeTo( application.getAimxcelFrame() );
