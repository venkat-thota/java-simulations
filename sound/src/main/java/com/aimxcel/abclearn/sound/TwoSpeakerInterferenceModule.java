...
import com.aimxcel.abclearn.sound.view.BufferedWaveMediumGraphic;
import com.aimxcel.abclearn.sound.view.InteractiveSpeakerGraphic;
import com.aimxcel.abclearn.sound.view.InterferenceListenerGraphic;
import com.aimxcel.abclearn.sound.view.ListenerGraphic;
import com.aimxcel.abclearn.sound.view.SoundApparatusPanel;
import com.aimxcel.abclearn.sound.view.SpeakerGraphic;
import com.aimxcel.abclearn.sound.view.TwoSourceInterferenceControlPanel;
...
//        wgB.setOpacity( 1f );
        ...
        try {
            ...
            AimxcelImageGraphic head = new AimxcelImageGraphic( apparatusPanel, headImg );
