...
public class DebugPSwingComponentAdapter extends JFrame {
    ...
    public DebugPSwingComponentAdapter() {
        ...
        // configure control panel at startup, as in Aimxcel hydrogen-atom sim
    ...
    */
    public class LightControlPanelNode extends AimxcelPNode {
    ...
    */
    ...
    /**
     * Executed synchronously on the AWT event dispatching thread, just like Aimxcel applications.
     *
     * @param args
     */
    public static void main( String[] args ) {
        if ( ENABLE_WORKAROUND_1 ) {
             ...
             * Unfortunately all Aimxcel application work this way, so this is
