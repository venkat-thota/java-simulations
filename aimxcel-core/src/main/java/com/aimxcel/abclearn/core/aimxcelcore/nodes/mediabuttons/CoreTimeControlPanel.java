...
public class CoreTimeControlPanel extends JPanel {
    ...
    private static final String DEFAULT_REWIND_TOOLTIP = AimxcelCommonResources.getString( AimxcelCommonResources.STRING_CLOCK_REWIND );
    ...
    private AimxcelPCanvas buttonCanvas;
    ...
    public CoreTimeControlPanel() {
        ...
        buttonCanvas = new AimxcelPCanvas();
    ...
    */
    ...
    public static void main( String[] args ) {
        ...
        CoreTimeControlPanel controls1 = new CoreTimeControlPanel();
