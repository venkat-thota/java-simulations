...
public class VSliderNode extends SliderNode {
    ...
    protected AimxcelPPath trackNode;
    ...
    public VSliderNode( IUserComponent userComponent, final double min, final double max, double trackThickness, double trackLength, double knobWidth, final SettableProperty<Double> value, final ObservableProperty<Boolean> enabled ) {
        ...
        trackNode = new AimxcelPPath( trackPath, new GradientPaint( 0, 0, Color.gray, 0, (float) trackLength, Color.white, false ), new BasicStroke( 1 ), Color.BLACK );
        ...
        AimxcelPPath knobBackground = new AimxcelPPath( leftKnobRect.createUnion( rightKnobRect ), null, null, null ) {/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
    ...
    public static void main( String[] args ) {
...

		{
            ...
            sliderNode.addLabel( +1, new AimxcelPText( "Positive", new AimxcelFont( 16 ) ) );
            sliderNode.addLabel( 0.0, new AimxcelPText( "0", new AimxcelFont( 16 ) ) );
            sliderNode.addLabel( -1, new AimxcelPText( "Negative", new AimxcelFont( 16 ) ) );
    ...
    public AimxcelPPath getTrackNode() { return trackNode; }
}