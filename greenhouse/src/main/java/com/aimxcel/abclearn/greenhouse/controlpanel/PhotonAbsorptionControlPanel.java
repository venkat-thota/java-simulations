...
import com.aimxcel.abclearn.photonabsorption.model.molecules.CH4;
import com.aimxcel.abclearn.photonabsorption.model.molecules.CO2;
import com.aimxcel.abclearn.photonabsorption.model.molecules.H2O;
import com.aimxcel.abclearn.photonabsorption.model.molecules.N2;
import com.aimxcel.abclearn.photonabsorption.model.molecules.O2;
...
public class PhotonAbsorptionControlPanel extends ControlPanel {
    ...
    public PhotonAbsorptionControlPanel( CoreModule module, final PhotonAbsorptionModel model ) {
        ...
        // the gas.
        AimxcelTitledPanel atmosphericGasesPanel = new AimxcelTitledPanel( GreenhouseResources.getString( "ControlPanel.AtmosphericGasesTitle" ) );
