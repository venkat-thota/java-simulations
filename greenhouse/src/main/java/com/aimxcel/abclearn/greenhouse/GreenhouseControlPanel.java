...
import com.aimxcel.abclearn.greenhouse.util.ModelViewTx1D;
...
public class GreenhouseControlPanel extends JPanel implements Resettable {
    ...
    public GreenhouseControlPanel( final GreenhouseModule module ) {
        ...
        // Reset button
        JButton resetBtn = new ResetAllButton( this, AimxcelApplication.getInstance().getAimxcelFrame() );
        ...
        {
            JPanel panel = new AimxcelTitledPanel(
        ...
        // Options panel
        JPanel optionsPanel = new AimxcelTitledPanel( GreenhouseResources.getString( "GreenhouseControlPanel.Options" ),
                BORDER_TITLE_FONT );
    ...
    private class AtmosphereSelectionPanel extends JPanel {
        ...
        AtmosphereSelectionPanel() {
            setBorder( new AimxcelTitledBorder( GreenhouseResources.getString( "GreenhouseControlPanel.TimePeriodBorderLabel" ), BORDER_TITLE_FONT ) );
...
//                greenhouseGasConcentrationControl.setEnabled( false );
    ...
    class ModelSlider extends JPanel {
        ...
        ModelSlider( String title, double minModelValue, double maxModelValue, double defaultModelValue ) {
            ...
            Font defaultFont = new AimxcelFont();
