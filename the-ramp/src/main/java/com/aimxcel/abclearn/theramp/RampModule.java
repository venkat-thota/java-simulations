...
import com.aimxcel.abclearn.theramp.model.RampModel;
...
import com.aimxcel.abclearn.theramp.timeseries.TimeSeriesPlaybackPanel;
import com.aimxcel.abclearn.theramp.view.FireDog;
...
public class RampModule extends CoreModule {
    ...
    public RampModule( String name, AimxcelFrame aimxcelFrame, final IClock clock ) {
        ...
        super.setAimxcelPCanvas( rampPanel );
    ...
    public boolean resetDialogOk() {
        ...
        Point loc = getAimxcelPCanvas().getLocationOnScreen();
