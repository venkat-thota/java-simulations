...
import com.aimxcel.abclearn.theramp.RampPlotSet;
...
import com.aimxcel.abclearn.theramp.view.bars.BarGraphSuite;
import com.aimxcel.abclearn.theramp.view.plot.TimeSeriesPNode;
...
public class RampPanel extends AimxcelPCanvas {
    ...
    public void graphLayoutChanged() {
        ...
        if ( Toolkit.getDefaultToolkit().getScreenSize().width <= 1024 && RampModule.MINIMIZE_READOUT_TEXT_FOR_SMALL_SCREEN ) {
            if ( allThreeGraphsUp() ) {
                rampPlotSet.setTimeSeriesPlotFont( new AimxcelFont( 9, true, false ) );
