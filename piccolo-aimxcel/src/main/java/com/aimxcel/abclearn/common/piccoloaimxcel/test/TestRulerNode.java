...
import com.aimxcel.abclearn.common.piccoloaimxcel.nodes.RulerNode;
...
public class TestRulerNode {
    ...
    public static void main( String[] args ) {
        ...
        Font majorTickFont = new AimxcelFont( Font.PLAIN, 14 );
        String units = "nm";
        Font unitsFont = new AimxcelFont( Font.PLAIN, 10 );
