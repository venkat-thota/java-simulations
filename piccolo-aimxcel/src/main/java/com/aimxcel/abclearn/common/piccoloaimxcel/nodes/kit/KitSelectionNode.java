...
import static com.aimxcel.abclearn.common.piccoloaimxcel.nodes.ControlPanelNode.DEFAULT_ARC;
...
public class KitSelectionNode<T extends PNode> extends PNode {
    ...
    public KitSelectionNode( IUserComponent userComponent, final Property<Integer> selectedKit, Option<PNode> titleNode, Kit<T>... kits ) {
        ...
        background = new AimxcelPPath( kitBounds, null, null, null );
        addChild( background );
            ...
            public void run() {
                new PFrame() {{
                    getCanvas().getLayer().addChild( new KitSelectionNode<PNode>(
                            ...
                            new Kit<PNode>( new AimxcelPPath( new Rectangle2D.Double( 0, 0, 100, 100 ), Color.blue ) ),
