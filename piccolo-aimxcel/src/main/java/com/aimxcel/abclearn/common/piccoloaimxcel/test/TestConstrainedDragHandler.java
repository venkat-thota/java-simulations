...
import com.aimxcel.abclearn.common.piccoloaimxcel.event.ConstrainedDragHandler;
...
public class TestConstrainedDragHandler extends JFrame {
    ...
    public TestConstrainedDragHandler() {
        ...
        AimxcelPCanvas playArea = createPlayAreaPanel();
    ...
    */
    private AimxcelPCanvas createPlayAreaPanel() {
        AimxcelPCanvas canvas = new AimxcelPCanvas( new Dimension( 500, 500 ) );

        PText instructionsNode = new PText( "Drag the red circle" );
        instructionsNode.setFont( new AimxcelFont( Font.BOLD, 24 ) );
