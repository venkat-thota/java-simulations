...
/**
 * AimxcelPNode provides useful extensions to the
 ...
 */
public class AimxcelPNode extends RichPNode {
     ...
     * This is useful for wrapping some PNode in a AimxcelPNode
     * in order to take advantage of some feature of AimxcelPNode.
     *
     * @param node
     */
    public AimxcelPNode( PNode node ) {
        this();
        addChild( node );
    }
