...
import com.aimxcel.abclearn.common.piccoloaimxcel.PiccoloAimxcelResources;
import com.aimxcel.abclearn.common.piccoloaimxcel.nodes.slider.VSliderNode;
...
public class HeaterCoolerNode extends PNode {
    ...
    public HeaterCoolerNode( Property<Double> heatCoolLevel, String heatLabel, String coolLabel ) {
        ...
        burner = new AimxcelPPath( stoveBodyShape.getGeneralPath(), stoveBodyPaint, new BasicStroke( 1 ), Color.BLACK );
        ...
        PNode burnerInterior = new AimxcelPPath( burnerInteriorShape, burnerInteriorPaint, new BasicStroke( 1 ), Color.LIGHT_GRAY );
    ...
    public static class HeaterCoolerSliderNode extends VSliderNode {
        ...
        private static final Font LABEL_FONT = new AimxcelFont( 20, true );
        ...
        public HeaterCoolerSliderNode( final SettableProperty<Double> value, String heatLabel, String coolLabel ) {
            ...
            addLabel( +1, new AimxcelPText( heatLabel, LABEL_FONT ) );
            addLabel( 0.0, new TickMark() );
            addLabel( -1, new AimxcelPText( coolLabel, LABEL_FONT ) );
        ...
        private static class TickMark extends PNode {
            ...
            private TickMark() {
                ...
                addChild( new AimxcelPPath( path.getGeneralPath(), STROKE, Color.BLACK ) );
            }
        }
    }
