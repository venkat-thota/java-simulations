...
package com.aimxcel.abclearn.common.piccoloaimxcel.services;
...
public class PNodeShowHideControl {
    ...
    static {
        HIDE_IMAGE_ICON = new ImageIcon( AimxcelCommonResources.getMinimizeButtonImage() );
        SHOW_IMAGE_ICON = new ImageIcon( AimxcelCommonResources.getMaximizeButtonImage() );
    }
