...
/**
 * AimxcelPCanvas is an extension of Piccolo's canvas that provides
...
public class AimxcelPCanvas extends PSwingCanvas implements Updatable {
    ...
    private AimxcelRootPNode phetRootNode;
    ...
    public AimxcelPCanvas( AimxcelPCanvas.TransformStrategy worldTransformStrategy ) {
        ...
        this.phetRootNode = new AimxcelRootPNode();
     ...
     * @param phetRootNode
     */
    public void setAimxcelRootNode( AimxcelRootPNode phetRootNode ) {
    ...
    public static class RenderingSizeStrategy implements TransformStrategy {
        ...
        public RenderingSizeStrategy( AimxcelPCanvas phetPCanvas, Dimension2D renderingSize ) {
        ...
        public void setAimxcelPCanvas( AimxcelPCanvas phetPCanvas ) {
            this.phetPCanvas = phetPCanvas;
        }
    ...
    public static class CenteringBoxStrategy implements TransformStrategy {
        ...
        public CenteringBoxStrategy( AimxcelPCanvas phetPCanvas, Dimension2D renderingSize ) {
            this.phetPCanvas = phetPCanvas;
            this.renderingSize = renderingSize;
            phetPCanvas.addComponentListener( new ComponentAdapter() {
                public void componentShown( ComponentEvent e ) {
    ...
    public static class CenterWidthScaleHeight implements TransformStrategy {
        ...
        public CenterWidthScaleHeight( AimxcelPCanvas phetPCanvas, Dimension2D renderingSize ) {
            this.phetPCanvas = phetPCanvas;
            this.renderingSize = renderingSize;
        }
    ...
    public static class ViewportStrategy implements TransformStrategy {
        ...
        public ViewportStrategy( AimxcelPCanvas phetPCanvas, Rectangle2D modelViewport ) {
            this.phetPCanvas = phetPCanvas;
