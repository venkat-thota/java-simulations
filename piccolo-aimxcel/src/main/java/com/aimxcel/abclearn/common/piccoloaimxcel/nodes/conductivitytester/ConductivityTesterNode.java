...
package com.aimxcel.abclearn.common.piccoloaimxcel.nodes.conductivitytester;
...
import com.aimxcel.abclearn.common.piccoloaimxcel.nodes.conductivitytester.IConductivityTester.ConductivityTesterChangeListener;
import com.aimxcel.abclearn.common.piccoloaimxcel.simsharing.SimSharingDragHandler;
 ...
 */
public class ConductivityTesterNode extends AimxcelPNode {
    ...
    private static BufferedImage getBufferedImage( String image ) {
        return new AimxcelResources( "piccolo-phet" ).getImage( image );
    }
    ...
    private static final Font PROBE_LABEL_FONT = new AimxcelFont( Font.BOLD, 24 );
    ...
    */
    private static class ProbeNode extends AimxcelPNode {
