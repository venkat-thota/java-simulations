...
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.ParameterValues;
...
import com.aimxcel.abclearn.common.aimxcelcommon.view.util.SpectrumImageFactory.LinearSpectrumImageFactory;
import com.aimxcel.abclearn.common.piccoloaimxcel.AimxcelPCanvas;
import com.aimxcel.abclearn.common.piccoloaimxcel.AimxcelPNode;
import com.aimxcel.abclearn.common.piccoloaimxcel.event.CursorHandler;
import com.aimxcel.abclearn.common.piccoloaimxcel.event.SliderThumbDragHandler;
import com.aimxcel.abclearn.common.piccoloaimxcel.event.SliderThumbDragHandler.Orientation;
...
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.UserActions.textFieldCorrected;
 ...
 */
public class WavelengthControl extends AimxcelPNode {
    ...
    private static final String UNITS_LABEL = AimxcelCommonResources.getString( "Common.wavelengthControl.nm" );
    ...
    private static final String UV_STRING = AimxcelCommonResources.getString( "Common.wavelengthControl.UV" );
    private static final String IR_STRING = AimxcelCommonResources.getString( "Common.wavelengthControl.IR" );
