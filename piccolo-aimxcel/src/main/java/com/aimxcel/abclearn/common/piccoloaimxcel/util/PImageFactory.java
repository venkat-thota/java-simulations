...
package com.aimxcel.abclearn.common.piccoloaimxcel.util;
...
public class PImageFactory {
     ...
     * @param imageName
     * @return
     * @deprecated the imageName arg require knowledge of where the image resources live in the JAR file, use PImage(AbcLearnResources.getImage(filename))
     */
     ...
     * @deprecated the imageName arg require knowledge of where the image resources live in the JAR file, use create(AbcLearnResources.getImage(filename),size)
     */
    ...
    * BufferedImage image = new AbcLearnResources(projectName).getImage(imageName);
