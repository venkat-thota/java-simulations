...
package com.aimxcel.abclearn.common.piccoloaimxcel.nodes.barchart;
...
import com.aimxcel.abclearn.common.piccoloaimxcel.nodes.ShadowHTMLNode;
...
public class BarChartNode extends PNode {
    ...
    public BarChartNode( String title, double scale, Paint backgroundColor, double barChartHeight ) {
        ...
        AimxcelPPath titleBackground = new AimxcelPPath( titleNode.getFullBounds(), backgroundColor );
        frontLayer.addChild( titleBackground );
        verticalLabelNode = new VerticalShadowHTMLNode( new AimxcelFont(), "", Color.red, Color.black );
    ...
    protected Font getTitleFont() {
        return new AimxcelFont( Font.BOLD, 18 );
    }
    ...
    public void init( Variable[] variables ) {
        ...
        for ( int i = 0; i < variables.length; i++ ) {
            ...
            final BarNode barGraphic = new BarNode( variable.getName(), scale,
                                                    ...
                                                    (int) barChartHeight, variable.getColor(), new AimxcelFont( Font.BOLD, 14 ) );
