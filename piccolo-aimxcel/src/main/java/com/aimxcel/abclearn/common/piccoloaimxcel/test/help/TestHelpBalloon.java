...
import com.aimxcel.abclearn.common.piccoloaimxcel.help.HelpBalloon;
import com.aimxcel.abclearn.common.piccoloaimxcel.help.HelpPane;
...
public class TestHelpBalloon extends AimxcelApplication {
    ...
    public static void main( final String[] args ) {
        ...
        AimxcelApplicationConfig phetApplicationConfig = new AimxcelApplicationConfig( args, "piccolo-phet" );
        new AimxcelApplicationLauncher().launchSim( phetApplicationConfig, applicationConstructor );
    }

    /* Application */
    public TestHelpBalloon( AimxcelApplicationConfig c ) throws InterruptedException {
        super( c );
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title ) {
            ...
            // Canvas
            final AimxcelPCanvas canvas = new AimxcelPCanvas( new Dimension( 1000, 1000 ) );
            ...
            textNode.setFont( new AimxcelFont( Font.BOLD, 16 ) );
            ...
            JPanel textPanel = new JPanel();
            {
                ...
                fontSizeSlider.addChangeListener( new ChangeListener() {
                    ...
                    public void stateChanged( ChangeEvent e ) {
                        Font font = new AimxcelFont( Font.PLAIN, fontSizeSlider.getValue() );
