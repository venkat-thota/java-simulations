...
package com.aimxcel.abclearn.common.piccoloaimxcel.test.help;
...
import com.aimxcel.abclearn.common.piccoloaimxcel.PiccoloModule;
import com.aimxcel.abclearn.common.piccoloaimxcel.event.CursorHandler;
import com.aimxcel.abclearn.common.piccoloaimxcel.help.GlassPaneCanvas;
import com.aimxcel.abclearn.common.piccoloaimxcel.nodes.HTMLNode;
 ...
 */
public class TestGlassPaneCanvas extends AimxcelApplication {
    ...
    public static void main( final String[] args ) {
        ...
        AimxcelApplicationConfig applicationConfig = new AimxcelApplicationConfig( args, "piccolo-phet" );
        new AimxcelApplicationLauncher().launchSim( applicationConfig, applicationConstructor );
    }

    /* Application */
    public TestGlassPaneCanvas( AimxcelApplicationConfig c ) throws InterruptedException {
        super( c );
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title, Color canvasColor ) {
            ...
            html.setFont( new AimxcelFont( Font.PLAIN, 18 ) );
            ...
            JFrame frame = AimxcelApplication.getInstance().getAimxcelFrame();
    ...
    public static class EventListener implements ActionListener, ChangeListener, ItemListener {
        ...
        private void showMessage( String message ) {
            JOptionPane.showMessageDialog( AimxcelApplication.getInstance().getAimxcelFrame(), message );
        }
    }
}
