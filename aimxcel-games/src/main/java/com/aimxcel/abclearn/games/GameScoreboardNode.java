...
public class GameScoreboardNode extends AimxcelPNode {
    ...
    // localized strings
    private static final String LABEL_SCORE = AimxcelCommonResources.getString( "Games.label.score" );
    ...
    private static final String MESSAGE_CONFIRM_NEW_GAME = AimxcelCommonResources.getString( "Games.message.confirmNewGame" );
    private static final String CONFIRM_TITLE = AimxcelCommonResources.getString( "Common.title.confirm" );
    ...
    private static final AimxcelFont FONT = new AimxcelFont( FONT_SIZE );
    private static final AimxcelFont BUTTON_FONT = new AimxcelFont( Font.BOLD, 18 );
    ...
    */
    private void handleNewGame() {
        if ( confirmNewGame ) {
            ...
            Component parent = AimxcelApplication.getInstance().getAimxcelFrame();
            int option = AimxcelOptionPane.showYesNoDialog( parent, MESSAGE_CONFIRM_NEW_GAME, CONFIRM_TITLE );
