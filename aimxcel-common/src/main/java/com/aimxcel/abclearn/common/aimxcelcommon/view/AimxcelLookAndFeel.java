...
public class AimxcelLookAndFeel {
    ...
    /**
     * Applies this AimxcelLookAndFeel, effectively installing the resources it
    ...
    /**
     * Constructs the UIDefaults that correspond to this AimxcelLookAndFeel,
...
// It should not be necessary to revalidate or repaint on top of that.
    ...
    /**
     * Determines the look and feel class name that will be used by this AimxcelLookAndFeel.
     ...
     * Our minimum supported resolution for Aimxcel simulations is 1024x768.
