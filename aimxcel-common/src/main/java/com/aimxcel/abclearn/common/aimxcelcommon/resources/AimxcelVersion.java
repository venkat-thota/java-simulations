...
/**
 * AimxcelVersionInfo encapsulates a simulation's version information.
 */
    ...
    */
    ...
    public long getTimestampSeconds() {
        ...
        try {
            ...
            System.err.println( "AimxcelVersion.getTimestampSeconds: timestamp is invalid, ignoring: " + timestamp );
            seconds = 0;
        }
        return seconds;
    }
