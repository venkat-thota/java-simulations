...
/**
 * Aimxcel preferences, stored in a file in the user's home directory.
 */
public class AimxcelPreferences {

    // if we don't have access permissions, this file will be null 
    private static AimxcelPreferencesFile PREFERENCES_FILE;
    ...
    static {
        try {
            PREFERENCES_FILE = new AimxcelPreferencesFile();
        }
        catch ( AccessControlException accessControlException ) {
            PREFERENCES_FILE = null;
            System.out.println( "AimxcelPreferences: access to local filesystem denied" );
        }
    }
     ...
     */
    private static class AimxcelPreferencesFile extends File {
        public AimxcelPreferencesFile() throws AccessControlException {
            super( new AimxcelPersistenceDir(), "preferences.properties" );
        }
    ...
    /* singleton */
    private static AimxcelPreferences instance;

    private final Properties properties = new Properties();

    /* singleton */
    private AimxcelPreferences() {
    ...
    public static AimxcelPreferences getInstance() {
        if ( instance == null ) {
            instance = new AimxcelPreferences();
        }
        return instance;
    }
    ...
    */
    ...
    private void storePreferences() {
        if ( PREFERENCES_FILE != null ) {
            try {
                properties.store( new FileOutputStream( PREFERENCES_FILE ), "Preferences for Aimxcel, see " + AimxcelCommonConstants.AIMXCEL_HOME_URL );
            }
            catch ( IOException e ) {
                e.printStackTrace();
            }
    ...
    public static void main( String[] args ) throws IOException {
        AimxcelPreferences aimxcelPreferences = new AimxcelPreferences();
        System.out.println( "aimxcelPreferences = " + aimxcelPreferences );
    }
}
