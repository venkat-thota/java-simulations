 ...
 * portions of IResourceLoader that are not Aimxcel specific.
 */
/* package private */
abstract class AbstractResourceLoader implements IResourceLoader {
     ...
     */
    public AimxcelProperties getProperties( String resourceName, final Locale locale ) {
        try {
            ...
            return new AimxcelProperties( properties );
        }
        catch ( IOException e ) {
            e.printStackTrace();
            return new AimxcelProperties( new Properties() );
        }
    }
