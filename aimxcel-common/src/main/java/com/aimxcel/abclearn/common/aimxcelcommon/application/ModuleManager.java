...
class ModuleManager {
    ...
    /**
     * Constructs a ModuleManager for a AimxcelApplication.
     *
     * @param aimxcelApplication
     */
    ModuleManager( AimxcelApplication aimxcelApplication ) {
    ...
    void addModule( Module module ) {
        ...
        modules.add( module );
        notifyModuleAdded( new ModuleEvent( getAimxcelApplication(), module ) );
    }
    ...
    void removeModule( Module module ) {
        ...
        // Notifiy listeners
        notifyModuleRemoved( new ModuleEvent( getAimxcelApplication(), module ) );
    }
    ...
    void setActiveModule( Module module ) {
        ...
        if ( activeModule != module ) {
            ...
            activate( module );
            notifyActiveModuleChanged( new ModuleEvent( getAimxcelApplication(), module ) );
            verifyActiveState();
        }
    }
    ...
    private AimxcelApplication getAimxcelApplication() {
