...
public class ModelSlider extends JPanel {
    ...
    private Font titleFont = new AimxcelFont( Font.BOLD, 12 );
    ...
    private void relabelSlider() {
        ...
        int dMinor = SLIDER_MAX / ( numMinorTicks - 1 );
        Font labelFont = new AimxcelFont( 0, 10 );
    ...
    public boolean testCommit() {
        try {
            ...
            String outofrange = AimxcelCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.OutOfRange" );
            String minimum = AimxcelCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Minimum" );
            String maximum = AimxcelCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Maximum" );
            String youentered = AimxcelCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.YouEntered" );
            String description = AimxcelCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Description" );
            AimxcelOptionPane.showMessageDialog( this, outofrange + ".\n" + minimum + "= " + ive.getMin()
                                                    + ", " + maximum + "=" + ive.getMax() + "\n" + youentered + ": "
