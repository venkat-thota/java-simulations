...
public class AWTSplashWindow extends Window {
    ...
    private static final String LOGO_RESOURCE_NAME = AimxcelLookAndFeel.AIMXCEL_LOGO_120x50;
    ...
    public AWTSplashWindow( Frame owner, String title ) {
        ...
        // UI components
        String message = AimxcelCommonResources.getInstance().getLocalizedString( "AimxcelApplication.StartupDialog.message" );
...
//        textComponent = new Label( labelString );
    ...
    private Image createLabelImage( String labelString, Color background, Color foreground ) {
        AimxcelFont font = new AimxcelFont( 13, false );
    ...
    /*
     * Gets the aimxcel logo image.
     */
    private static BufferedImage getLogoImage() {
        return AimxcelCommonResources.getInstance().getImage( LOGO_RESOURCE_NAME );
    }
