...
public class ControlPanel extends JPanel {
     ...
     * It does not enforce the Aimxcel convention that the "Reset All" button is at the bottom
    ...
    public JButton addResetAllButton( final Resettable[] resettables ) {
        JButton resetAllButton = new ResetAllButton( resettables, AimxcelApplication.getInstance().getAimxcelFrame() );
