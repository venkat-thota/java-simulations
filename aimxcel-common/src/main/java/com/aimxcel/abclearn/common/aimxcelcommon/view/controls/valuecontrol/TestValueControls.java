...
import com.aimxcel.abclearn.common.aimxcelcommon.view.controls.valuecontrol.TestValueControls;
...
public class TestValueControls extends JFrame {
	...
	public TestValueControls() {
        ...
        final LinearValueControl potatoControl;
        {
            ...
            Icon icon = new ImageIcon( AimxcelCommonResources.getImage( "buttons/closeButton.png" ) );
    ...
    public static void main( String[] args ) {
        try {
            // Set the look and feel to match the one used by Aimxcel sims.
