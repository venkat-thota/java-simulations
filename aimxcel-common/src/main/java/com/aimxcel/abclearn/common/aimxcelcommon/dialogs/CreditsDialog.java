...
import com.aimxcel.abclearn.common.aimxcelcommon.dialogs.ContribLicenseDialog;
...
import com.aimxcel.abclearn.common.aimxcelcommon.util.AnnotationParser;
...
public class CreditsDialog extends PaintImmediateDialog {
    ...
    private static final String TITLE = AimxcelCommonResources.getString( "Common.About.CreditsDialog.Title" );
    private static final String CLOSE_BUTTON = AimxcelCommonResources.getString( "Common.choice.close" );
    private static final String LICENSE_DETAILS_TITLE = AimxcelCommonResources.getString( "Common.About.CreditsDialog.licenseDetails" );
    ...
    private static class DevelopmentTeamCredits {
        ...
        private static final String TITLE = AimxcelCommonResources.getString( "Common.About.CreditsDialog.AimxcelDevelopmentTeam" );
        private static final String FILENAME = "credits.txt";

        // Localized labels to display in the credits, one label per role.
        private static final String LABEL_LEAD_DESIGN = AimxcelCommonResources.getString( "Common.About.CreditsDialog.lead-design" );
        private static final String LABEL_SOFTWARE_DEVELOPMENT = AimxcelCommonResources.getString( "Common.About.CreditsDialog.software-development" );
        private static final String LABEL_DESIGN_TEAM = AimxcelCommonResources.getString( "Common.About.CreditsDialog.design-team" );
        private static final String LABEL_INTERVIEWS = AimxcelCommonResources.getString( "Common.About.CreditsDialog.interviews" );
    ...
    private static class TranslationCredits {
        ...
        private static final String TITLE = AimxcelCommonResources.getString( "Common.About.CreditsDialog.TranslationCreditsTitle" );
        ...
        private String readCredits() {
            AimxcelResources resourceLoader = new AimxcelResources( projectName );
    ...
    private static class ThirdPartySoftwareCredits {
        ...
        private static final String TITLE = AimxcelCommonResources.getString( "Common.About.CreditsDialog.UsesThirdPartySoftware" );
        ...
        private String readLicenseInfoFile() {
            ...
            try {
                ...
                System.err.println( getClass().getName() + ": missing  " + resourceName +
                                    " - Did you generate license info for this sim, using AimxcelBuildGUI->Misc->Generate License Info ?" );
            }
         ...
         * These files are placed in the contrib-licenses directory by the aimxcel build process,
         * via the Misc menu in AimxcelBuildGUI
         */
