...
public class XMLPersistenceManager {
    ...
    private static final String SAVE_TITLE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.title" );
    private static final String SAVE_CONFIRM_MESSAGE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.confirm.message" );
    private static final String SAVE_ERROR_MESSAGE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.error.message" );
    private static final String SAVE_ERROR_ENCODE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.error.encode" );

    private static final String LOAD_TITLE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.title" );
    private static final String LOAD_ERROR_MESSAGE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.message" );
    private static final String LOAD_ERROR_DECODE = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.decode" );
    private static final String LOAD_ERROR_CONTENTS = AimxcelCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.contents" );
    ...
    private static abstract class AbstractObjectSaveLoadStrategy implements ISaveLoadStrategy {
        ...
        */
        protected void showError( String format, String errorMessage ) {
            ...
            AimxcelOptionPane.showErrorDialog( _parentFrame, message );
        }
    }
        ...
        public void save( Object object ) {
            ...
            try {
                ...
                if ( selectedFile.exists() ) {
                    String title = AimxcelCommonResources.getInstance().getLocalizedString( "Common.title.confirm" );
                    int reply = AimxcelOptionPane.showYesNoDialog( getParentFrame(), SAVE_CONFIRM_MESSAGE, title );
