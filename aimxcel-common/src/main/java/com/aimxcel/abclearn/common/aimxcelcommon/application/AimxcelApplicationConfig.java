...
public class AimxcelApplicationConfig implements ISimInfo {
    ...
    //This frame setup should be used for all aimxcel applications, to ensure a consistent window size
    ...
    private AimxcelLookAndFeel aimxcelLookAndFeel = new AimxcelLookAndFeel(); // the look and feel to be initialized in launchSim
    ...
    public AimxcelApplicationConfig( String[] commandLineArgs, String project, String flavor ) {
        ...
        if ( hasCommandLineArg( "-log" ) ) {
            LoggingUtils.enableAllLogging( "com.aimxcel.abclearn.common.aimxcelcommon" );
        }
        this.flavor = flavor;
        this.resourceLoader = new AimxcelResources( project );
        this.frameSetup = DEFAULT_FRAME_SETUP;
        this.aimxcelLookAndFeel = new AimxcelLookAndFeel();
    }
    ...
    public void setLookAndFeel( AimxcelLookAndFeel aimxcelLookAndFeel ) {
        this.aimxcelLookAndFeel = aimxcelLookAndFeel;
    }

    public AimxcelLookAndFeel getLookAndFeel() {
        return aimxcelLookAndFeel;
    }
