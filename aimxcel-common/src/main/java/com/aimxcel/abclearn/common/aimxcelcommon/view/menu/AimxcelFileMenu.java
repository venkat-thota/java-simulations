...
public class AimxcelFileMenu extends SimSharingJMenu {
	...
	public AimxcelFileMenu( final AimxcelFrame aimxcelFrame, final ISimInfo simInfo ) {
        ...
        if ( simInfo.isPreferencesEnabled() ) {
           // addPreferencesMenuItem( aimxcelFrame, simInfo );
            addSeparator();
        }
        ...
        exitMI.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                aimxcelFrame.getApplication().exit();
            }
        } );
    ...
    private void addPreferencesMenuItem( final AimxcelFrame aimxcelFrame, final ISimInfo simInfo ) {
        ...
        preferencesMenuItem.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                new PreferencesDialog( aimxcelFrame,
