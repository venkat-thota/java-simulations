...
public class SimSharingManager {
    ...
    // Use if you have a non-AimxcelApplication (e.g., a sample main) that involves sim-sharing and you want basic console output.
     ...
     * Calling this method before AimxcelApplicationLauncher.launchSim is a programming error, and will
     * result in IllegalStateException. We can't test for a SimSharingConfig until we receive the
     * AimxcelApplicationConfig from AimxcelApplicationLauncher, which contains the name of the study.
     * And we don't call getInstance herein, because getInstance will happily initialize with a
     * dummy AimxcelApplicationConfig.
     */
