...
public class AimxcelInstallation {
    ...
    private static final String PROPERTIES_FILENAME = "aimxcel-installation.properties";

    private static AimxcelInstallation instance;

    // properties associated with the Aimxcel installation
    ...
    /**
     * Gets the version information associated with the installer that was used to create the Aimxcel installation.
     *
     * @return
     */
    ...
    /**
     * Does a Aimxcel installation exists that is associated with this sim?
     *
     * @return
     */
    ...
    */
    ...
    /*
    * Gets the properties file associated the the Aimxcel installation.
