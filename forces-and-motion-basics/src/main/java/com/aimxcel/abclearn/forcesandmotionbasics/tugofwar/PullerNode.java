...
import com.aimxcel.abclearn.forcesandmotionbasics.ForcesAndMotionBasicsResources;
import com.aimxcel.abclearn.forcesandmotionbasics.tugofwar.TugOfWarCanvas.Mode;
import com.aimxcel.abclearn.forcesandmotionbasics.tugofwar.TugOfWarCanvas.PullerColor;
import com.aimxcel.abclearn.forcesandmotionbasics.tugofwar.TugOfWarCanvas.PullerSize;
...
public class PullerNode extends PNode {
    ...
    private final AimxcelPPath attachmentNode;
    ...
    public PullerNode( final IUserComponent component, final PullerColor color, final PullerSize size, final double scale, Vector2D offset, final PullerContext context, final ObservableProperty<Mode> mode ) {
        ...
        final double w = 10;
        attachmentNode = new AimxcelPPath( new Ellipse2D.Double( -w / 2, -w / 2, w, w ), new BasicStroke( 2 ), TRANSPARENT ) {/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
