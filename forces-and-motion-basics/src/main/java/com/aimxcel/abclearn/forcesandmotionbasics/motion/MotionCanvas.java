...
import com.aimxcel.abclearn.forcesandmotionbasics.ForcesAndMotionBasicsSimSharing.ModelComponents;
...
import com.aimxcel.abclearn.forcesandmotionbasics.tugofwar.ForcesNode;
...
import com.aimxcel.abclearn.common.aimxcelcommon.model.property.doubleproperty.CompositeDoubleProperty;
import com.aimxcel.abclearn.common.aimxcelcommon.model.property.doubleproperty.DoubleProperty;
import com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.ModelActions;
...
import com.aimxcel.abclearn.core.aimxcelcore.nodes.SpeedometerNode;
...
import static com.aimxcel.abclearn.forcesandmotionbasics.ForcesAndMotionBasicsSimSharing.UserComponents.accelerometerCheckBoxIcon;
import static com.aimxcel.abclearn.forcesandmotionbasics.ForcesAndMotionBasicsSimSharing.UserComponents.showForcesCheckBoxIcon;
import static com.aimxcel.abclearn.forcesandmotionbasics.ForcesAndMotionBasicsSimSharing.UserComponents.speedCheckBoxIcon;
import static com.aimxcel.abclearn.forcesandmotionbasics.motion.StackableNode._isOnSkateboard;
import static com.aimxcel.abclearn.forcesandmotionbasics.motion.StackableNode._mass;
import static com.aimxcel.abclearn.common.aimxcelcommon.math.vector.Vector2D.ZERO;
import static com.aimxcel.abclearn.common.aimxcelcommon.math.vector.Vector2D.v;
...
import static com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.ParameterKeys.isSelected;
...
import static com.aimxcel.abclearn.common.aimxcelcommon.view.util.BufferedImageUtils.multiScaleToHeight;
    ...
    public MotionCanvas( final Resettable moduleContext, final IClock clock,
        ...
        if ( showClouds ) {
...

			{
				...
				{
                    scale( 0.6 );
                }}, new AimxcelPPath( new Rectangle2D.Double( 0, 0, 1, 1 ), new Color( 0, 0, 0, 0 ) ) {/**
					 * 
					 */
					private static final long serialVersionUID = 1L;
        ...
        PNode terrainLayer = new PNode() {
            ...
            private void updateBackgroundLayer( final Double position ) {
                ...
                //Show mountains as additional texture
                {
                    ...
                    AimxcelPPath path = new AimxcelPPath( area, new TexturePaint( mountains, anchor ) ) {/**
						 * 
						 */
						private static final long serialVersionUID = 1L;
                ...
                //Extend the brick region an extra stage width to the left and right, in case it is a very odd aspect ratio.  (But no support for showing wider than that).
                {
                    ...
                    AimxcelPPath path = new AimxcelPPath( area, new TexturePaint( Images.BRICK_TILE, anchor ) ) {/**
						 * 
						 */
						private static final long serialVersionUID = 1L;
                ...
                if ( friction && model.frictionValue.get() == 0 ) {
                    ...
                    AimxcelPPath path = new AimxcelPPath( area, new TexturePaint( Images.ICE_OVERLAY, anchor ) ) {/**
						 * 
						 */
						private static final long serialVersionUID = 1L;
                ...
                if ( showClouds ) {
                    ...
                    addChild( new AimxcelPPath( area, new TexturePaint( txtr, anchor ) ) );
                }
                ...
                if ( friction && model.frictionValue.get() > 0 ) {
                    ...
                    AimxcelPPath path = new AimxcelPPath( area, new TexturePaint( image, anchor ) ) {/**
						 * 
						 */
						private static final long serialVersionUID = 1L;
...
//        }}
        ...
        skateboard = friction ?
                     new AimxcelPPath( new Rectangle( 0, 0, Images.SKATEBOARD.getWidth(), 1 ), new Color( 0, 0, 0, 0 ), null, null ) :
        ...
        AimxcelPPath leftToolbox = new AimxcelPPath( toolboxShape, TOOLBOX_COLOR, new BasicStroke( 1 ), Color.black );
        ...
        AimxcelPPath rightToolbox = new AimxcelPPath( toolboxShape, TOOLBOX_COLOR, new BasicStroke( 1 ), Color.black );
...
//        }}
...

		{
            ...
            addChild( new VBox( 0, new AimxcelPText( Strings.ACCELERATION, new AimxcelFont( (int) ( 16 * 1.25 ) ) ), a ) );
            addChild( new AimxcelPText( "-20", new AimxcelFont( 15 ) ) {/**
				 * 
				 */
				private static final long serialVersionUID = 1L;
            ...
            addChild( new AimxcelPText( "0", new AimxcelFont( 15 ) ) {/**
				 * 
				 */
				private static final long serialVersionUID = 1L;
    ...
    private PNode indent( final PNode component ) {
        return new HBox( 15, new AimxcelPPath( new Rectangle( 0, 0, 1, 1 ), new Color( 0, 0, 0, 0 ) ), component );
    }
