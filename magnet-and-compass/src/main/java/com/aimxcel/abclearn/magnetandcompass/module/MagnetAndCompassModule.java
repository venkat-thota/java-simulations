...
import com.aimxcel.abclearn.magnetandcompass.view.DebuggerGraphic;



public abstract class MagnetAndCompassModule extends SimSharingAimxcelGraphicsModule implements ICompassGridModule {
     ...
     */
    public MagnetAndCompassModule( IUserComponent tabUserComponent, String title ) {
        super( tabUserComponent, title, new SwingClock( MagnetAndCompassConstants.CLOCK_DELAY, MagnetAndCompassConstants.CLOCK_STEP ) );
        setLogoPanel( null );
    }
