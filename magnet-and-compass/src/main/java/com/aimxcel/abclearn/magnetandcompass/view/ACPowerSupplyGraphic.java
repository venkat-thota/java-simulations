...
public class ACPowerSupplyGraphic extends GraphicLayerSet implements SimpleObserver {
    ...
    private MagnetAndCompassSlider _maxAmplitudeSlider;
    private MagnetAndCompassSlider _frequencySlider;
    ...
    public ACPowerSupplyGraphic( Component component, ACPowerSupply acPowerSupplyModel ) {
        ...
        {
            _maxAmplitudeSlider = new MagnetAndCompassSlider( qualifiedUserComponent( Components.maxAmplitudeSlider ), component, 100 /* track length */ );

            _maxAmplitudeSlider.setMinimum( (int) ( 100.0 * MagnetAndCompassConstants.AC_MAXAMPLITUDE_MIN ) );
            _maxAmplitudeSlider.setMaximum( (int) ( 100.0 * MagnetAndCompassConstants.AC_MAXAMPLITUDE_MAX ) );
        ...
        // Frequency slider
        {
            _frequencySlider = new MagnetAndCompassSlider( qualifiedUserComponent( Components.frequencySlider ), component, 100 /* track length */ );

            _frequencySlider.setMinimum( (int) ( 100.0 * MagnetAndCompassConstants.AC_FREQUENCY_MIN ) );
            _frequencySlider.setMaximum( (int) ( 100.0 * MagnetAndCompassConstants.AC_FREQUENCY_MAX ) );
        ...
        // Sine Wave
        {
            ...
            _waveGraphic.setMaxCycles( MagnetAndCompassConstants.AC_FREQUENCY_MAX / MagnetAndCompassConstants.AC_FREQUENCY_MIN );
...
//                          "  amplitude=" + _acPowerSupplyModel.getAmplitude() * 100 + "%" );
    ...
    private static class BackgroundGraphic extends AimxcelImageGraphic {
        ...
        public BackgroundGraphic( Component component ) {
            ...
            // AC panel
            BufferedImage powerSupplyImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.AC_POWER_SUPPLY_IMAGE );
            AimxcelImageGraphic panel = new AimxcelImageGraphic( component, powerSupplyImage );
            graphicLayerSet.addGraphic( panel, PANEL_LAYER );

            // Title label
            {
                AimxcelTextGraphic title = new AimxcelTextGraphic( component, TITLE_FONT, MagnetAndCompassStrings.TITLE_AC_POWER_SUPPLY, TITLE_COLOR );
