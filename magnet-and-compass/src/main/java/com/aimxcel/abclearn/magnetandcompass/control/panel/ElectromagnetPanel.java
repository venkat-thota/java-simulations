...
import com.aimxcel.abclearn.magnetandcompass.view.ElectromagnetGraphic;


public class ElectromagnetPanel extends MagnetAndCompassPanel {
    ...
    public ElectromagnetPanel(
        ...
        TitledBorder titledBorder = BorderFactory.createTitledBorder( border, MagnetAndCompassStrings.TITLE_ELECTROMAGNET_PANEL );
        titledBorder.setTitleFont( getTitleFont() );
        setBorder( titledBorder );

        // B-field on/off
        _bFieldCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.showFieldCheckBox ), MagnetAndCompassStrings.CHECK_BOX_SHOW_B_FIELD );

        // Field Meter on/off
        _fieldMeterCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.showFieldMeterCheckBox ), MagnetAndCompassStrings.CHECK_BOX_SHOW_FIELD_METER );

        // Compass on/off
        _compassCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.showCompassCheckBox ), MagnetAndCompassStrings.CHECK_BOX_SHOW_COMPASS );
        ...
        JPanel loopsPanel = new JPanel();
        {
            ...
            spinnerModel.setMaximum( new Integer( MagnetAndCompassConstants.ELECTROMAGNET_LOOPS_MAX ) );
            spinnerModel.setMinimum( new Integer( MagnetAndCompassConstants.ELECTROMAGNET_LOOPS_MIN ) );
            spinnerModel.setValue( new Integer( MagnetAndCompassConstants.ELECTROMAGNET_LOOPS_MIN ) );
        ...
        {
            // Title
            TitledBorder indicatorBorder = new TitledBorder( MagnetAndCompassStrings.TITLE_CURRENT_SOURCE );
            ...
            ImageIcon batteryIcon = new ImageIcon( MagnetAndCompassResources.getImage( MagnetAndCompassConstants.BATTERY_ICON ) );
            ImageIcon batteryIconSelected = new ImageIcon( MagnetAndCompassResources.getImage( MagnetAndCompassConstants.BATTERY_ICON_SELECTED ) );
            _batteryRadioButton = new SimSharingJRadioButton( qualifyUserComponent( Components.dcRadioButton ), MagnetAndCompassStrings.RADIO_BUTTON_DC, batteryIcon );
            ...
            ImageIcon acIcon = new ImageIcon( MagnetAndCompassResources.getImage( MagnetAndCompassConstants.AC_POWER_SUPPLY_ICON ) );
            ImageIcon acIconSelected = new ImageIcon( MagnetAndCompassResources.getImage( MagnetAndCompassConstants.AC_POWER_SUPPLY_ICON_SELECTED ) );
            _acRadioButton = new SimSharingJRadioButton( qualifyUserComponent( Components.acRadioButton ), MagnetAndCompassStrings.RADIO_BUTTON_AC, acIcon );
