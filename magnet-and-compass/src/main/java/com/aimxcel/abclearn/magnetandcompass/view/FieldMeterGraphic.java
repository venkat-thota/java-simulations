...
public class FieldMeterGraphic extends CompositeAimxcelGraphic
    ...
    public FieldMeterGraphic( Component component, FieldMeter fieldMeterModel ) {
        ...
        BufferedImage fieldMeterImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.FIELD_METER_IMAGE );
        ...
        AimxcelTextGraphic titleText = new AimxcelTextGraphic( component, TITLE_FONT, MagnetAndCompassStrings.TITLE_FIELD_METER, TITLE_COLOR, 0, 0 );
        ...
        // Setup interactivity.
        _mouseHandler = new MagnetAndCompassMouseHandler( Components.fieldMeter, UserComponentTypes.sprite, _fieldMeterModel, this );
        super.setCursorHand();
