...
import com.aimxcel.abclearn.magnetandcompass.view.*;



public class DeveloperControlsPanel extends MagnetAndCompassPanel {
    ...
    public DeveloperControlsPanel( 
        ...
        if ( bFieldInsideGraphic != null || bFieldOutsideGraphic != null ) {
            double min = MagnetAndCompassConstants.GRID_INTENSITY_SCALE_MIN;
            double max = MagnetAndCompassConstants.GRID_INTENSITY_SCALE_MAX;
        ...
        if ( pickupCoilModel != null ) {
            double min = MagnetAndCompassConstants.PICKUP_CALIBRATION_EMF_MIN;
            double max = MagnetAndCompassConstants.PICKUP_CALIBRATION_EMF_MAX;
        ...
        if ( pickupCoilGraphic != null ) {
            double min = MagnetAndCompassConstants.PICKUP_ELECTRONS_SPEED_SCALE_MIN;
            double max = MagnetAndCompassConstants.PICKUP_ELECTRONS_SPEED_SCALE_MAX;
        ...
        if ( pickupCoilModel != null ) {
            double min = MagnetAndCompassConstants.PICKUP_TRANSITION_SMOOTHING_SCALE_MIN;
            double max = MagnetAndCompassConstants.PICKUP_TRANSITION_SMOOTHING_SCALE_MAX;
        ...
        if ( lightbulbGraphic != null ) {
            double min = MagnetAndCompassConstants.LIGHTBULB_GLASS_GLOW_SCALE_MIN;
            double max = MagnetAndCompassConstants.LIGHTBULB_GLASS_GLOW_SCALE_MAX;
