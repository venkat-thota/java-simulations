...
public class MagnetAndCompassObservable extends SimpleObservable {
     ...
     */
    public MagnetAndCompassObservable() {
     ...
     */
    public MagnetAndCompassObservable( Point2D location, double direction ) {
        super();
