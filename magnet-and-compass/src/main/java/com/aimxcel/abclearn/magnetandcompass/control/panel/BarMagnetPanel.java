...
import com.aimxcel.abclearn.magnetandcompass.view.BFieldInsideGraphic;
import com.aimxcel.abclearn.magnetandcompass.view.BFieldOutsideGraphic;
import com.aimxcel.abclearn.magnetandcompass.view.EarthGraphic;



public class BarMagnetPanel extends MagnetAndCompassPanel {
    ...
    public BarMagnetPanel(
        ...
        TitledBorder titleBorder = BorderFactory.createTitledBorder( lineBorder, MagnetAndCompassStrings.TITLE_BAR_MAGNET_PANEL );
        ...
        // Magnet strength
        {
            ...
            int max = 100;
            int min = (int) ( 100.0 * MagnetAndCompassConstants.BAR_MAGNET_STRENGTH_MIN / MagnetAndCompassConstants.BAR_MAGNET_STRENGTH_MAX );

            // Slider
            _strengthControl = new SimSharingLinearValueControl( qualifyUserComponent( Components.strengthControl ), min, max, MagnetAndCompassStrings.LABEL_STRENGTH, "0", "%" );
        ...
        _flipPolarityButton = new SimSharingJButton( qualifyUserComponent( Components.flipPolarityButton ), MagnetAndCompassStrings.BUTTON_FLIP_POLARITY );

        // Magnet transparency on/off
        _seeInsideCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.seeInsideMagnetCheckBox ), MagnetAndCompassStrings.CHECK_BOX_SEE_INSIDE );
        ...
        // Earth on/off
        _earthCheckBox = new SimSharingJCheckBox( UserComponentChain.chain( Components.showEarthCheckBox ), MagnetAndCompassStrings.CHECK_BOX_SHOW_EARTH );
     ...
     */
    public void update() {
        _strengthControl.setValue( (int) ( 100.0 * _barMagnetModel.getStrength() / MagnetAndCompassConstants.BAR_MAGNET_STRENGTH_MAX ) );
    ...
    private class EventListener implements ActionListener, ChangeListener {
        ...
        public void stateChanged( ChangeEvent e ) {
            if ( e.getSource() == _strengthControl ) {
                ...
                // Update the model.
                double strength = ( percent / 100.0 ) * MagnetAndCompassConstants.BAR_MAGNET_STRENGTH_MAX;
