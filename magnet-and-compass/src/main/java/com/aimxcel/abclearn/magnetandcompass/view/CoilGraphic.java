...
import com.aimxcel.abclearn.magnetandcompass.model.AbstractCoil;
...
import com.aimxcel.abclearn.magnetandcompass.util.QuadBezierSpline;
...
public class CoilGraphic implements SimpleObserver {
    ...
    private double calculateElectronSpeed() {
        ...
        if ( Math.abs( currentAmplitude ) < MagnetAndCompassConstants.CURRENT_AMPLITUDE_THRESHOLD ) {
            currentAmplitude = 0;
        }
