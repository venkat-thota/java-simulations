...
import com.aimxcel.abclearn.magnetandcompass.util.VariableAlphaImageGraphic;
...
public class LightbulbGraphic extends CompositeAimxcelGraphic implements SimpleObserver {
    ...
    public LightbulbGraphic( Component component, Lightbulb lightbulbModel ) {
        ...
        // Glass
        BufferedImage glassImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.LIGHTBULB_GLASS_IMAGE );
        _glassGraphic = new VariableAlphaImageGraphic( component, glassImage );
        addGraphic( _glassGraphic, BULB_LAYER );
        
        // Cap
        BufferedImage capImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.LIGHTBULB_CAP_IMAGE );
        AimxcelImageGraphic capGraphic = new AimxcelImageGraphic( component, capImage );
        addGraphic( capGraphic, BULB_LAYER );
        
        // Base
        BufferedImage baseImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.LIGHTBULB_BASE_IMAGE );
