...
import com.aimxcel.abclearn.magnetandcompass.model.MagnetAndCompassObservable;



public class MagnetAndCompassMouseHandler extends MouseInputAdapter {
    ...
    private MagnetAndCompassObservable _modelComponent;
     ...
     */
    public MagnetAndCompassMouseHandler( IUserComponent userComponent, IUserComponentType userComponentType, MagnetAndCompassObservable modelComponent, AimxcelGraphic viewComponent ) {
        super();
