...
import com.aimxcel.abclearn.magnetandcompass.view.WiggleMeGraphic;



public class BarMagnetModule extends MagnetAndCompassModule {
    ...
    public BarMagnetModule( boolean wiggleMeEnabled ) {
        ...
        super( Components.barMagnetTab, MagnetAndCompassStrings.TITLE_BAR_MAGNET_MODULE );
        ...
        _bFieldInsideGraphic.setNeedleSize( MagnetAndCompassConstants.GRID_NEEDLE_SIZE );
    ...
    private static class ThisWiggleMeGraphic extends WiggleMeGraphic implements SimpleObserver {
        ...
        public ThisWiggleMeGraphic( Component component, BaseModel model, BarMagnet barMagnetModel, Compass compassModel ) {
            ...
            setText( MagnetAndCompassStrings.WIGGLEME_BAR_MAGNET );
