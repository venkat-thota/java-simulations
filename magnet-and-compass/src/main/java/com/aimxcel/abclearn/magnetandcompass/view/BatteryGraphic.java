...
import com.aimxcel.abclearn.magnetandcompass.control.GraphicSlider;
...
public class BatteryGraphic extends GraphicLayerSet implements SimpleObserver {
    ...
    public BatteryGraphic( Component component, Battery batteryModel ) {
        ...
        // Battery image
        {
            BufferedImage batteryImage = MagnetAndCompassResources.getImage( MagnetAndCompassConstants.BATTERY_IMAGE );
        ...
        // Amplitude slider
        {
            _amplitudeSlider = new MagnetAndCompassSlider( Components.batterySlider, component, 100 /* track length */ );
    ...
    public void update() {
        ...
        if ( isVisible() ) {
            ...
            {
                // Format the text
                String text = VOLTAGE_FORMAT.format( Math.abs( voltage ) ) + " " + MagnetAndCompassStrings.UNITS_VOLTS;
