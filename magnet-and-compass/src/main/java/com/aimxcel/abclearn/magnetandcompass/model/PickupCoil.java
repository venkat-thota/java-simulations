...
public class PickupCoil extends AbstractCoil implements ModelElement, SimpleObserver {
    ...
    */
     ...
     * Calculates the induced emf using MagnetAndCompass's Law.
     *
     * @param dt time delta
     */
    ...
    /**
     * Updates the induced emf (and other related instance data), using MagnetAndCompass's Law.
     */
    ...
    */
    private double getEffectiveLoopArea() {
        double width = MagnetAndCompassConstants.MIN_PICKUP_LOOP_RADIUS;
