...
package com.aimxcel.abclearn.magnetandcompass.test;
...
public class TestBFieldGrid extends JFrame {
    ...
    private static final Dimension MAGNET_SIZE = MagnetAndCompassConstants.BAR_MAGNET_SIZE; // value used when generating data files in MathCAD
    ...
    public static class Grid {
        ...
        */
        private double[][] readGridComponent( String resourceName, Dimension size ) {
            ...
            int count = 0;
            try {
                InputStream is = MagnetAndCompassResources.getResourceLoader().getResourceAsStream( resourceName );
