...
import com.aimxcel.abclearn.magnetandcompass.control.panel.ElectromagnetPanel;
...
import com.aimxcel.abclearn.magnetandcompass.model.AbstractCurrentSource;
...
public class TransformerModule extends MagnetAndCompassModule {
    ...
    // Electromagnet
    private static final int ELECTROMAGNET_NUMBER_OF_LOOPS = MagnetAndCompassConstants.ELECTROMAGNET_LOOPS_MAX;
    ...
    private static final double PICKUP_COIL_LOOP_AREA = 0.75 * MagnetAndCompassConstants.MAX_PICKUP_LOOP_AREA;
    ...
    public TransformerModule() {
        ...
        super( Components.transformerTab, MagnetAndCompassStrings.TITLE_TRANSFORMER_MODULE );
        ...
        _batteryModel.setMaxVoltage( MagnetAndCompassConstants.BATTERY_VOLTAGE_MAX );
        _batteryModel.setAmplitude( BATTERY_AMPLITUDE );

        // AC Source 
        _acPowerSupplyModel = new ACPowerSupply();
        _acPowerSupplyModel.setMaxVoltage( MagnetAndCompassConstants.AC_VOLTAGE_MAX );
        ...
        _electromagnetModel.setMaxStrength( MagnetAndCompassConstants.ELECTROMAGNET_STRENGTH_MAX );
        ...
        _bFieldOutsideGraphic = new BFieldOutsideGraphic( apparatusPanel, _electromagnetModel, MagnetAndCompassConstants.GRID_SPACING, MagnetAndCompassConstants.GRID_SPACING );
