...
public class MagnetAndCompassConstants {
   
    // Not intended for instantiation.
    private MagnetAndCompassConstants() {}
    ...
    public static final String PROJECT_NAME = "magnet-and-compass";
    
    public static final String FLAVOR_FARADAY = "magnet-and-compass";
    ...
    public static final int CLOCK_DELAY = ( 1000 / MagnetAndCompassConstants.CLOCK_FRAME_RATE ); // milliseconds
