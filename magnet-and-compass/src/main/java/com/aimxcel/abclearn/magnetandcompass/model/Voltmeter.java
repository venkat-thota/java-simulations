...
public class Voltmeter extends MagnetAndCompassObservable implements ModelElement, SimpleObserver {
    ...
    private double getDesiredNeedleAngle() {
        ...
        if ( Math.abs( amplitude ) < MagnetAndCompassConstants.CURRENT_AMPLITUDE_THRESHOLD ) {
            amplitude = 0;
        }
