...
import com.aimxcel.abclearn.magnetandcompass.control.panel.TurbinePanel;
...
import com.aimxcel.abclearn.magnetandcompass.view.TurbineGraphic;



public class GeneratorModule extends MagnetAndCompassModule {
    ...
    // Turbine
    private static final Dimension TURBINE_SIZE = MagnetAndCompassConstants.BAR_MAGNET_SIZE;
    private static final double TURBINE_STRENGTH = 0.75 * MagnetAndCompassConstants.TURBINE_STRENGTH_MAX;
    ...
    public GeneratorModule() {
        ...
        super( Components.generatorTab, MagnetAndCompassStrings.TITLE_GENERATOR_MODULE );
        ...
        _turbineModel.setMaxStrength( MagnetAndCompassConstants.TURBINE_STRENGTH_MAX );
        _turbineModel.setMinStrength( MagnetAndCompassConstants.TURBINE_STRENGTH_MIN );
        ...
        _bFieldOutsideGraphic = new BFieldOutsideGraphic( apparatusPanel, _turbineModel, MagnetAndCompassConstants.GRID_SPACING, MagnetAndCompassConstants.GRID_SPACING );
