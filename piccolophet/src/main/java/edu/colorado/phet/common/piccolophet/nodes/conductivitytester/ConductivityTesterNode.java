...
import com.aimxcel.abclearn.common.abclearncommon.math.Function.LinearFunction;
...
import static com.aimxcel.abclearn.common.abclearncommon.math.MathUtil.clamp;
 ...
 */
public class ConductivityTesterNode extends AbcLearnPNode {
    ...
    private static BufferedImage getBufferedImage( String image ) {
        return new AbcLearnResources( "piccolo-phet" ).getImage( image );
    }
    ...
    private static final Font PROBE_LABEL_FONT = new AbcLearnFont( Font.BOLD, 24 );
    ...
    */
    private static class ProbeNode extends AbcLearnPNode {
