...
public class TestButtonTextCentering {
    ...
    public static void test1() {
        ...
        HTMLImageButtonNode button1 = new HTMLImageButtonNode( "xxx", new AbcLearnFont( Font.BOLD, 18 ), Color.ORANGE );
        button1.setOffset( 500, 500 );
        button1.addActionListener( listener );

        AbcLearnPCanvas canvas = new AbcLearnPCanvas();
        canvas.setWorldTransformStrategy( new AbcLearnPCanvas.CenteredStage( canvas, STAGE_SIZE ) );
    ...
    public static void test2() {
        ...
        frame.setContentPane( new JPanel() {
            @Override protected void paintComponent( Graphics g ) {
                ...
                g2.setFont( new AbcLearnFont( Font.BOLD, 18 ) );
    ...
    public static void test3() {
        ...
        final Font font = new AbcLearnFont( 18, true );
