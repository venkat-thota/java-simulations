...
import com.aimxcel.abclearn.common.abclearncommon.util.RichSimpleObserver;
import com.aimxcel.abclearn.common.abclearncommon.util.function.Function3;
import com.aimxcel.abclearn.common.abclearncommon.view.graphics.TriColorRoundGradientPaint;
...
public class KnobNode extends PNode {
    ...
    public KnobNode( final double width, ColorScheme colorScheme ) {
        ...
        *----------------------------------------------------------------------------*/
        ...
        final AbcLearnPPath background = new AbcLearnPPath( knobShape ) {{
