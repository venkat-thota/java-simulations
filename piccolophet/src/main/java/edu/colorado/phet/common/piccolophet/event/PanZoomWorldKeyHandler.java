...
public class PanZoomWorldKeyHandler implements KeyListener {
    ...
    public PanZoomWorldKeyHandler( AbcLearnPCanvas phetPCanvas ) {
...
//            }
    ...
    private void zoomWorld( double scale ) {
        ...
        phetPCanvas.getAbcLearnRootNode().globalToWorld( point );
        phetPCanvas.getAbcLearnRootNode().scaleWorldAboutPoint( scale, point );
    }

    private void translateWorld( int dx, int dy ) {
        phetPCanvas.getAbcLearnRootNode().translateWorld( dx, dy );
    }
