...
import edu.colorado.phet.common.piccolophet.AbcLearnTabbedPane;

public class TestAbcLearnTabbedPane {
    public static void main( String[] args ) {
        JFrame frame = new JFrame( "Tab Test" );
        final AbcLearnTabbedPane phetTabbedPane = new AbcLearnTabbedPane();
        ...
        slider.addChangeListener( new ChangeListener() {
            public void stateChanged( ChangeEvent e ) {
                ...
                phetTabbedPane.setTabFont( new AbcLearnFont( Font.BOLD, slider.getValue() ) );
            }
        } );
