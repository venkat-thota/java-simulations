...
public class TestHTMLNodeBounds extends JFrame {
    ...
    public TestHTMLNodeBounds() {
        ...
        htmlNode.setFont( new AbcLearnFont( DEFAULT_FONT_SIZE ) );
        ...
        JLabel fontNameLabel = new JLabel( "font face name: " + new AbcLearnFont().getFontName() );
        ...
        fontSizeSpinner.addChangeListener( new ChangeListener() {
            ...
            public void stateChanged( ChangeEvent e ) {
                ...
                htmlNode.setFont( new AbcLearnFont( fontSize ) );
            }
        } );
    ...
    public static void main( String[] args ) {
        SwingUtilities.invokeLater( new Runnable() {
            public void run() {
                ...
                label.setFont( new AbcLearnFont( 53 ) );
