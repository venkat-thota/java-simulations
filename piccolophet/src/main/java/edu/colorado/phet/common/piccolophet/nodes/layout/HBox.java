    ...
    public static void main( String[] args ) {
        ...
        class TestBox extends HBox {
            public TestBox( VerticalPositionStrategy positionStrategy, String name ) {
                ...
                addChild( new AbcLearnPPath( new Rectangle2D.Double( 0, 0, 50, 50 ) ) );
                addChild( new AbcLearnPPath( new Ellipse2D.Double( 0, 0, 75, 75 ) ) );
                addChild( new AbcLearnPPath( new Ellipse2D.Double( -100, -100, 100, 100 ) ) );
            }
        }
