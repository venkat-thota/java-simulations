...
public class TestConstrainedDragHandler extends JFrame {
    ...
    public TestConstrainedDragHandler() {
        ...
        AbcLearnPCanvas playArea = createPlayAreaPanel();
    ...
    */
    private AbcLearnPCanvas createPlayAreaPanel() {
        AbcLearnPCanvas canvas = new AbcLearnPCanvas( new Dimension( 500, 500 ) );

        PText instructionsNode = new PText( "Drag the red circle" );
        instructionsNode.setFont( new AbcLearnFont( Font.BOLD, 24 ) );
