...
import com.aimxcel.abclearn.common.abclearncommon.patterns.Updatable;
...
/**
 * AbcLearnPCanvas is an extension of Piccolo's canvas that provides
 ...
 */
public class AbcLearnPCanvas extends PSwingCanvas implements Updatable {

    private static final Logger LOGGER = Logger.getLogger( AbcLearnPCanvas.class.getCanonicalName() );
    ...
    private AbcLearnRootPNode phetRootNode;
    ...
    /**
     * Constructs a AbcLearnPCanvas that uses an identify transform for world nodes.
     */
    public AbcLearnPCanvas() {
        this( new ConstantTransformStrategy( new AffineTransform() ) );
    }

    /**
     * Constructs a AbcLearnPCanvas with the size that will be used as the
     ...
     */
    public AbcLearnPCanvas( Dimension2D renderingSize ) {
    ...
    /**
     * Constructs a AbcLearnPCanvas with a specified viewport for world nodes.
     *
     * @param modelViewport
     */
    public AbcLearnPCanvas( Rectangle2D modelViewport ) {
        this( new ConstantTransformStrategy( new AffineTransform() ) ); //HACK
        setWorldTransformStrategy( new ViewportStrategy( this, modelViewport ) );
    }

    /**
     * Constructs a AbcLearnPCanvas with a specified world transform strategy.
     *
     * @param worldTransformStrategy
     */
    public AbcLearnPCanvas( AbcLearnPCanvas.TransformStrategy worldTransformStrategy ) {
        ...
        this.phetRootNode = new AbcLearnRootPNode();
    ...
    /**
     * Gets the AbcLearnRootPNode associated with the PCanvas.
     *
     * @return AbcLearnRootPNode
     */
    public AbcLearnRootPNode getAbcLearnRootNode() {
        return phetRootNode;
    }

    /**
     * Sets the AbcLearnRootPNode associated with the PCanvas.
     *
     * @param phetRootNode
     */
    public void setAbcLearnRootNode( AbcLearnRootPNode phetRootNode ) {
    ...
    public Dimension2D getWorldSize() {
        ...
        getAbcLearnRootNode().screenToWorld( dim ); // modifies dim!
        return dim;
    }
    ...
    public PBounds getWorldBounds() {
        ...
        getAbcLearnRootNode().screenToWorld( origin ); // modifies origin!
    ...
    public static class RenderingSizeStrategy implements TransformStrategy {
        ...
        public RenderingSizeStrategy( AbcLearnPCanvas phetPCanvas, Dimension2D renderingSize ) {
    ...
    public static class CenteringBoxStrategy implements TransformStrategy {
        ...
        public CenteringBoxStrategy( AbcLearnPCanvas phetPCanvas, Dimension2D renderingSize ) {
            this.phetPCanvas = phetPCanvas;
            this.renderingSize = renderingSize;
            phetPCanvas.addComponentListener( new ComponentAdapter() {
                public void componentShown( ComponentEvent e ) {
    ...
    public static class CenterWidthScaleHeight implements TransformStrategy {
        ...
        public CenterWidthScaleHeight( AbcLearnPCanvas phetPCanvas, Dimension2D renderingSize ) {
            this.phetPCanvas = phetPCanvas;
            this.renderingSize = renderingSize;
        }
    ...
    public static class ViewportStrategy implements TransformStrategy {
        ...
        public ViewportStrategy( AbcLearnPCanvas phetPCanvas, Rectangle2D modelViewport ) {
            this.phetPCanvas = phetPCanvas;
    ...
    /**
     * Centers a "stage" area, of a specified size, within the AbcLearnPCanvas, scaling it up and down so it is always
    ...
    public static class CenteredStage implements TransformStrategy {
        ...
        public CenteredStage( AbcLearnPCanvas canvas ) {
            // Create this strategy using the default stage size.
            this( canvas, DEFAULT_STAGE_SIZE );

        }

        public CenteredStage( AbcLearnPCanvas canvas, Dimension2D stageSize ) {
            this.canvas = canvas;
