 ...
 * @author Sam Reid
 */
public class AbcLearnTitledPanel extends VerticalLayoutPanel {

    public AbcLearnTitledPanel( String title ) {
        this( title, AbcLearnTitledBorder.DEFAULT_FONT );
    }

    public AbcLearnTitledPanel( String title, final Font font ) {
        ...
        //Create and set the AbcLearnTitledPanelBorder which will render the border
        final AbcLearnTitledPanelBorder border = new AbcLearnTitledPanelBorder( Color.black, title, font );
        setBorder( border );
