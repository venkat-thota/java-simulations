 ...
 * The root node is in the "world" coordinate frame (see AbcLearnPCanvas) and methods are provided for centering
 ...
 */
public class CenteredStageCanvas extends AbcLearnPCanvas implements Resettable {
    ...
    public CenteredStageCanvas( Dimension2D stageSize ) {
        ...
        if ( AbcLearnApplication.getInstance().getSimInfo().hasCommandLineArg( "-showStageBounds" ) ) {
