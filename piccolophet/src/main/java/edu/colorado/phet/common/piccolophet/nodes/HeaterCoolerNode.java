...
import com.aimxcel.abclearn.common.abclearncommon.util.DoubleRange;
import com.aimxcel.abclearn.common.abclearncommon.util.function.VoidFunction1;
import com.aimxcel.abclearn.common.abclearncommon.view.util.ColorUtils;
import com.aimxcel.abclearn.common.abclearncommon.view.util.DoubleGeneralPath;
import com.aimxcel.abclearn.common.abclearncommon.view.util.AbcLearnFont;
import edu.colorado.phet.common.piccolophet.PiccoloAbcLearnResources;
...
public class HeaterCoolerNode extends PNode {
    ...
    public HeaterCoolerNode( Property<Double> heatCoolLevel, String heatLabel, String coolLabel ) {
        ...
        burner = new AbcLearnPPath( stoveBodyShape.getGeneralPath(), stoveBodyPaint, new BasicStroke( 1 ), Color.BLACK );
        ...
        PNode burnerInterior = new AbcLearnPPath( burnerInteriorShape, burnerInteriorPaint, new BasicStroke( 1 ), Color.LIGHT_GRAY );
        ...
        fireImage = new PImage( PiccoloAbcLearnResources.getImage( "flame.png" ) );
        fireImage.setScale( ( WIDTH * 0.8 ) / fireImage.getFullBoundsReference().getWidth() );

        iceImage = new PImage( PiccoloAbcLearnResources.getImage( "ice-cube-stack.png" ) );
    ...
    public static class HeaterCoolerSliderNode extends VSliderNode {
        ...
        private static final Font LABEL_FONT = new AbcLearnFont( 20, true );
        ...
        public HeaterCoolerSliderNode( final SettableProperty<Double> value, String heatLabel, String coolLabel ) {
            ...
            addLabel( +1, new AbcLearnPText( heatLabel, LABEL_FONT ) );
            addLabel( 0.0, new TickMark() );
            addLabel( -1, new AbcLearnPText( coolLabel, LABEL_FONT ) );
        ...
        private static class TickMark extends PNode {
            ...
            private TickMark() {
                ...
                addChild( new AbcLearnPPath( path.getGeneralPath(), STROKE, Color.BLACK ) );
            }
        }
    }
        ...
        SwingUtilities.invokeLater( new Runnable() {
            public void run() {
                new PiccoloTestFrame( "Heater-Cooler Node Test" ) {{
                    addNode( new AbcLearnPPath( new Rectangle2D.Double( 0, 0, 1000, 1000 ), Color.black ) );
