...
public class PNodeShowHideControl {
    ...
    static {
        HIDE_IMAGE_ICON = new ImageIcon( AbcLearnCommonResources.getMinimizeButtonImage() );
        SHOW_IMAGE_ICON = new ImageIcon( AbcLearnCommonResources.getMaximizeButtonImage() );
    }
