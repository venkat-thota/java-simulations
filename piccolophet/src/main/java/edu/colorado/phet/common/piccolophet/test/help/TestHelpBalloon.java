 ...
 */
public class TestHelpBalloon extends AbcLearnApplication {
    ...
    public static void main( final String[] args ) {
        ...
        AbcLearnApplicationConfig phetApplicationConfig = new AbcLearnApplicationConfig( args, "piccolo-phet" );
        new AbcLearnApplicationLauncher().launchSim( phetApplicationConfig, applicationConstructor );
    }

    /* Application */
    public TestHelpBalloon( AbcLearnApplicationConfig c ) throws InterruptedException {
        super( c );
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title ) {
            ...
            // Canvas
            final AbcLearnPCanvas canvas = new AbcLearnPCanvas( new Dimension( 1000, 1000 ) );
            ...
            textNode.setFont( new AbcLearnFont( Font.BOLD, 16 ) );
            ...
            JPanel textPanel = new JPanel();
            {
                ...
                fontSizeSlider.addChangeListener( new ChangeListener() {
                    ...
                    public void stateChanged( ChangeEvent e ) {
                        Font font = new AbcLearnFont( Font.PLAIN, fontSizeSlider.getValue() );
