...
public class ComboBoxNode<T> extends PNode {
    ...
    private static final Font DEFAULT_FONT = new AbcLearnFont( 18 );
    ...
    private static class TriangleNode extends PNode {
        private TriangleNode() {
            addChild( new AbcLearnPPath( new Rectangle2D.Double( 0, 0, 20, 20 ), Color.lightGray ) );
            addChild( new AbcLearnPPath( new DoubleGeneralPath( 2, 8 ) {{
                lineToRelative( 8, 8 );
                lineToRelative( 8, -8 );
                closePath();
    ...
    private static class NodeWithBackground extends PNode {
        ...
        public NodeWithBackground( PNode node, double width ) {
            ...
            background = new AbcLearnPPath( new Rectangle2D.Double( -2, 0, width + 2 + 2, node.getFullBounds().getHeight() ), plainColor );
