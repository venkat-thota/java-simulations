...
/**
 * Developer controls for the properties of AbcLearnTabbedPane.
...
public class TabbedPanePropertiesDialog extends PaintImmediateDialog {
    ...
    public TabbedPanePropertiesDialog( final Frame parent, AbcLearnTabbedPane tabbedPane ) {
    ...
    private JPanel createInputPanel( Frame parent, final AbcLearnTabbedPane tabbedPane ) {
