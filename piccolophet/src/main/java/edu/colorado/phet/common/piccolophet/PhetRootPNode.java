...
/**
 * AbcLearnRootPNode provides a convenient mechanism for interleaving
 ...
 * their transforms.
 * <p/>
 * This node is intended for use by AbcLearnPCanvas only, and should not be
 * used directly in simulations.
 */
public class AbcLearnRootPNode extends PNode {
