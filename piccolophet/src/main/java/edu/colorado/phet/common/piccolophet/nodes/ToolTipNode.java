...
public class ToolTipNode extends PComposite {
    ...
    private static final Font DEFAULT_FONT = new AbcLearnFont( 12 );
    ...
    */
    ...
    public static void main( String[] args ) {
        ...
        instructionsNode.setFont( new AbcLearnFont( 14 ) );
        ...
        blueToolTipNode.setFont( new AbcLearnFont( 24, true ) );
