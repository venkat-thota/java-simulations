 ...
 */
public class TestHelpPane extends AbcLearnApplication {
    ...
    /* Application */
    public TestHelpPane( AbcLearnApplicationConfig config ) throws InterruptedException {
        super( config );
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title, Color canvasColor, Color screenChildColor, Color worldChildColor ) {
            ...
            // Canvas
            AbcLearnPCanvas canvas = new AbcLearnPCanvas( new Dimension( 1000, 1000 ) );
