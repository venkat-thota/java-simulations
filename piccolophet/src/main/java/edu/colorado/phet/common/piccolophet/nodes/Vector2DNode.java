...
import com.aimxcel.abclearn.common.abclearncommon.math.PolarCartesianConverter;
 ...
 */
public class Vector2DNode extends AbcLearnPNode {
    ...
    private static final Font DEFAULT_VALUE_FONT = new AbcLearnFont();
