...
import com.aimxcel.abclearn.common.abclearncommon.view.AbcLearnColorScheme;
...
public class MeasuringTape extends AbcLearnPNode {
...
//        System.out.println( "bodyGraphic.getTransform() = " + bodyGraphic.getTransform() );
    ...
    class ReadoutGraphic extends PNode {
        ...
        public ReadoutGraphic( String units ) {
            ...
            phetShadowTextGraphic.setFont( new AbcLearnFont( Font.BOLD, 14 ) );
        ...
        public void setDistance( double modelDistance ) {
            phetShadowTextGraphic.setText( AbcLearnCommonResources.formatValueUnits( decimalFormat.format( modelDistance ), units ) );
        }
    ...
    static class CrossHairGraphic extends PNode {
        public CrossHairGraphic( int length ) {
            ...
            verticalStroke.setStrokePaint( AbcLearnColorScheme.RED_COLORBLIND );

            PPath horizStroke = new PPath( new Line2D.Double( 0, length / 2, length, length / 2 ) );
            horizStroke.setStroke( new BasicStroke( 2 ) );
            horizStroke.setStrokePaint( AbcLearnColorScheme.RED_COLORBLIND );
