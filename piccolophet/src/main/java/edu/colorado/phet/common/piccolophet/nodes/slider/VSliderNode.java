...
import edu.colorado.phet.common.piccolophet.nodes.AbcLearnPText;
...
public class VSliderNode extends SliderNode {
    ...
    protected AbcLearnPPath trackNode;
    ...
    public VSliderNode( IUserComponent userComponent, final double min, final double max, double trackThickness, double trackLength, double knobWidth, final SettableProperty<Double> value, final ObservableProperty<Boolean> enabled ) {
        ...
        trackNode = new AbcLearnPPath( trackPath, new GradientPaint( 0, 0, Color.gray, 0, (float) trackLength, Color.white, false ), new BasicStroke( 1 ), Color.BLACK );
        ...
        AbcLearnPPath knobBackground = new AbcLearnPPath( leftKnobRect.createUnion( rightKnobRect ), null, null, null ) {{
            setPickable( false );
    ...
    public static void main( String[] args ) {
        new PFrame( "test", false, new PCanvas() {{
            ...
            sliderNode.addLabel( +1, new AbcLearnPText( "Positive", new AbcLearnFont( 16 ) ) );
            sliderNode.addLabel( 0.0, new AbcLearnPText( "0", new AbcLearnFont( 16 ) ) );
            sliderNode.addLabel( -1, new AbcLearnPText( "Negative", new AbcLearnFont( 16 ) ) );
    ...
    public AbcLearnPPath getTrackNode() { return trackNode; }
}