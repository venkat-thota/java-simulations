...
public class MediaPlaybackBarNode extends PNode {
    ...
    private AbcLearnPPath fillPath;
    private AbcLearnPPath braidPath;

    public MediaPlaybackBarNode( double width, double height ) {
        this.width = width;
        this.height = height;
//        outerShape = new AbcLearnPPath( Color.lightGray, new BasicStroke( 1 ), Color.black );
        outerShape = new AbcLearnPPath( Color.lightGray );
        fillPath = new AbcLearnPPath( Color.gray );
        braidPath = new AbcLearnPPath( new BasicStroke( 2 ), Color.red );
