...
/**
 * AbcLearnPNode provides useful extensions to the
 ...
 */
public class AbcLearnPNode extends RichPNode {
     ...
     * This is useful for wrapping some PNode in a AbcLearnPNode
     * in order to take advantage of some feature of AbcLearnPNode.
     *
     * @param node
     */
    public AbcLearnPNode( PNode node ) {
        this();
        addChild( node );
    }
