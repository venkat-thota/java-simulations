 ...
 */
public class BufferedPNode extends AbcLearnPNode {
     ...
     */
    public BufferedPNode( final AbcLearnPCanvas canvas, final PNode managedNode ) {
        super();
    ...
    private static class RescaledNode extends PImage {
        ...
        public RescaledNode( AbcLearnPCanvas canvas, Image image ) {
            super( image );
            this.canvas = canvas;
        ...
        protected void paint( PPaintContext paintContext ) {
            if ( rescaledImage != null ) {
                ...
                canvas.getAbcLearnRootNode().globalToScreen( bounds );
