...
import com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.ParameterValues;
...
import com.aimxcel.abclearn.common.abclearncommon.view.util.SpectrumImageFactory.LinearSpectrumImageFactory;
import com.aimxcel.abclearn.common.abclearncommon.view.util.VisibleColor;
...
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.UserActions.textFieldCorrected;
 ...
 */
public class WavelengthControl extends AbcLearnPNode {
    ...
    private static final String UNITS_LABEL = AbcLearnCommonResources.getString( "Common.wavelengthControl.nm" );
    ...
    private static final String UV_STRING = AbcLearnCommonResources.getString( "Common.wavelengthControl.UV" );
    private static final String IR_STRING = AbcLearnCommonResources.getString( "Common.wavelengthControl.IR" );
    ...
    public static void main( String[] args ) {
        new JFrame() {{
            setContentPane( new AbcLearnPCanvas() {{
