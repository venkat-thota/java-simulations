...
public class TestLinearValueControlPSwing {
    ...
    public TestLinearValueControlPSwing() {
        ...
        final AbcLearnPCanvas contentPane = new AbcLearnPCanvas();
        contentPane.setWorldTransformStrategy( new AbcLearnPCanvas.CenteringBoxStrategy( contentPane, new PDimension( 800, 600 ) ) );
