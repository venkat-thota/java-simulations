...
import static com.aimxcel.abclearn.common.abclearncommon.resources.AbcLearnCommonResources.PICCOLO_ABC_LEARN_VELOCITY_SENSOR_NODE_SPEED;
...
public class VelocitySensorNode extends DraggableSensorNode<Vector2D> {
    ...
    public VelocitySensorNode( final ModelViewTransform transform, final VelocitySensor velocitySensor, final double arrowScale, final ObservableProperty<Function1<Vector2D, String>> formatter,
        ...
        this( transform, velocitySensor, arrowScale, formatter, new Function1.Identity<Point2D>(), PICCOLO_ABC_LEARN_VELOCITY_SENSOR_NODE_UNKNOWN, valueWithLongestString );
    }
    ...
    public VelocitySensorNode( final ModelViewTransform transform,
        ...
        super( transform, velocitySensor, formatter, boundedConstraint, unknownDisplayString, PICCOLO_ABC_LEARN_VELOCITY_SENSOR_NODE_SPEED, valueWithLongestString );
