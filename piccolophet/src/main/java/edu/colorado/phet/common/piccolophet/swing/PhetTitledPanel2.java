...
/**
 * Feasibility test for AbcLearnTitlePanel, we will probably use something more like AbcLearnTitledPanel3 since this implementation
 * restricts the layout to be that of a VerticalLayoutPanel and will silently fail if the layout is changed.
 *
 * @author Sam Reid
 */
public class AbcLearnTitledPanel2 extends VerticalLayoutPanel {

    public AbcLearnTitledPanel2( String title ) {
        this( title, AbcLearnTitledBorder.DEFAULT_FONT );
    }

    public AbcLearnTitledPanel2( String title, final Font font ) {
        setFillNone();
        setAnchor( GridBagConstraints.WEST );
        final AbcLearnTitledPanelBorder border = new AbcLearnTitledPanelBorder( Color.blue, title, font );
        setBorder( border );
    ...
    public static void main( String[] args ) {
        ...
        final JPanel contentPane = new AbcLearnTitledPanel2( "aoensuthasnotehuBorder" );
        for ( int i = 0; i < 10; i++ ) {
    ...
    public static class AbcLearnTitledPanelBorder extends AbstractBorder {
        protected Color lineColor;
        private final Font font;
        protected PText text;

        public AbcLearnTitledPanelBorder( Color color, String title, final Font font ) {
            lineColor = color;
            this.font = font;
