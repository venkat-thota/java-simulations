...
import com.aimxcel.abclearn.common.abclearncommon.model.property.ChangeObserver;
...
import com.aimxcel.abclearn.common.abclearncommon.view.LogoPanel;
...
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.ParameterKeys.text;
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.UserActions.pressed;

/**
 * The AbcLearnTabbedPane is a Piccolo implementation of a tabbed pane.  In general, the interface resembles JTabbedPane.
...
public class AbcLearnTabbedPane extends JPanel {

    public static final String IMAGE_ABC_LEARN_LOGO = LogoPanel.IMAGE_ABC_LEARN_LOGO;

    /* Default property values */
    public static final Font DEFAULT_TAB_FONT = new AbcLearnFont( 16, true /* bold */ );
    ...
    /**
     * Constructs a AbcLearnTabbedPane using the default color scheme.
     */
    public AbcLearnTabbedPane() {
...
//todo This fixed version works correctly for the TestAbcLearnTabbedPane test under 1.4 and 1.5, so maybe the fault was originally with QWI.  This warrants further investigation.
        if ( component != null ) {
    ...
    /**
     * Sets the main body component of the AbcLearnTabbedPane.
     *
     * @param component
     */
    ...
    private static abstract class AbstractTabNode extends PNode {
        ...
        private AbcLearnPPath background; /*Draws the gradient background, use AbcLearnPPath for Gradient workaround on Mac OS 10.4 */
        ...
        public AbstractTabNode( IUserComponent userComponent, String text, JComponent component, Color selectedTabColor, Color unselectedTabColor, Color selectedTextColor, Color unselectedTextColor, Font tabFont ) {
            ...
            background = new AbcLearnPPath( createTabShape( textNode.getFullBounds().getWidth(), textNode.getFullBounds().getHeight() ) );
...
//            return selected?tabFont : new Font( tabFont.getName(),Font.PLAIN, tabFont.getSize() );
    ...
    private static class TabBase extends PNode {
        private final AbcLearnPPath path; // use AbcLearnPPath for Gradient workaround on Mac OS 10.4
        private int tabBaseHeight = 9;
        private Color color;

        public TabBase( Color color ) {
            this.color = color;
            path = new AbcLearnPPath( new Rectangle( 0, 0, 200, tabBaseHeight ) );
            path.setPaint( color );
    ...
    private static class TabPane extends PSwingCanvas {
        ...
        public TabPane( Color selectedTabColor, Color unselectedTabColor ) {
            Image image = AbcLearnCommonResources.getInstance().getImage( IMAGE_ABC_LEARN_LOGO );
            logo = new PImage( image );
            logo.addInputEventListener( new CursorHandler() );
            logo.addInputEventListener( new ToolTipHandler( AbcLearnCommonResources.getInstance().getLocalizedString( "Common.About.WebLink" ), this ) );
    ...
    protected class TabInputListener extends PBasicInputEventHandler {
        ...
        public void mouseEntered( PInputEvent event ) {
            AbcLearnTabbedPane.this.setCursor( Cursor.getPredefinedCursor( Cursor.HAND_CURSOR ) );
        }

        public void mouseExited( PInputEvent event ) {
            AbcLearnTabbedPane.this.setCursor( Cursor.getPredefinedCursor( Cursor.DEFAULT_CURSOR ) );
        }
    }
    ...
    public static class TabbedModule extends Module {
        ...
        // associate tabs with their respective AbcLearnTabbedPane.HTMLTabNode instance and vice versa
        ...
        public TabbedModule( final Component content ) {
            ...
            tabPane = new TabPane( AbcLearnTabbedPane.DEFAULT_SELECTED_TAB_COLOR, AbcLearnTabbedPane.DEFAULT_UNSELECTED_TAB_COLOR );
        ...
        public void addTab( final Tab tab ) {
            HTMLTabNode tabNode = new HTMLTabNode( tab.getUserComponent(), tab.getTitle(), null,
                                                   AbcLearnTabbedPane.DEFAULT_SELECTED_TAB_COLOR, AbcLearnTabbedPane.DEFAULT_UNSELECTED_TAB_COLOR,
                                                   AbcLearnTabbedPane.DEFAULT_SELECTED_TEXT_COLOR, AbcLearnTabbedPane.DEFAULT_UNSELECTED_TEXT_COLOR,
                                                   AbcLearnTabbedPane.DEFAULT_TAB_FONT ) {{
