...
public class MomentaryButtonNode extends PNode {
    ...
    public static void main( String[] args ) {
        ...
        PNode button = new MomentaryButtonNode( new UserComponent( "testButton"),
                                                buttonOn, PiccoloAbcLearnResources.getImage( "button_pressed.png" ), PiccoloAbcLearnResources.getImage( "button_unpressed.png" ),
                                                buttonEnabled, PiccoloAbcLearnResources.getImage( "button_pressed_disabled.png" ), PiccoloAbcLearnResources.getImage( "button_unpressed_disabled.png" ));
