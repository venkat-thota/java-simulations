...
public class TabbedPanePropertiesMenuItem extends JCheckBoxMenuItem {
    ...
    public TabbedPanePropertiesMenuItem( final Frame owner, final AbcLearnTabbedPane tabbedPane ) {
        super( ITEM_LABEL );
    ...
    private void handleAction( final Frame owner, final AbcLearnTabbedPane tabbedPane ) {
        if ( isSelected() ) {
