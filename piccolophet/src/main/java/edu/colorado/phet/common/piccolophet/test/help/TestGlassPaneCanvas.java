 ...
 */
public class TestGlassPaneCanvas extends AbcLearnApplication {
    ...
    public static void main( final String[] args ) {
        ...
        AbcLearnApplicationConfig applicationConfig = new AbcLearnApplicationConfig( args, "piccolo-phet" );
        new AbcLearnApplicationLauncher().launchSim( applicationConfig, applicationConstructor );
    }

    /* Application */
    public TestGlassPaneCanvas( AbcLearnApplicationConfig c ) throws InterruptedException {
        super( c );
    ...
    private static class TestModule extends PiccoloModule {
        ...
        public TestModule( String title, Color canvasColor ) {
            ...
            html.setFont( new AbcLearnFont( Font.PLAIN, 18 ) );
            ...
            JFrame frame = AbcLearnApplication.getInstance().getAbcLearnFrame();
    ...
    public static class EventListener implements ActionListener, ChangeListener, ItemListener {
        ...
        private void showMessage( String message ) {
            JOptionPane.showMessageDialog( AbcLearnApplication.getInstance().getAbcLearnFrame(), message );
        }
    }
}
