...
public class PiccoloTimeControlPanel extends JPanel {
    ...
    private static final String DEFAULT_PLAY_TOOLTIP = AbcLearnCommonResources.getString( AbcLearnCommonResources.STRING_CLOCK_PLAY );
    private static final String DEFAULT_PAUSE_TOOLTIP = AbcLearnCommonResources.getString( AbcLearnCommonResources.STRING_CLOCK_PAUSE );
    private static final String DEFAULT_STEP_TOOLTIP = AbcLearnCommonResources.getString( AbcLearnCommonResources.STRING_CLOCK_STEP );
    private static final String DEFAULT_STEP_BACK_TOOLTIP = AbcLearnCommonResources.getString( AbcLearnCommonResources.STRING_CLOCK_STEP_BACK );
    private static final String DEFAULT_REWIND_TOOLTIP = AbcLearnCommonResources.getString( AbcLearnCommonResources.STRING_CLOCK_REWIND );
    ...
    private AbcLearnPCanvas buttonCanvas;
    ...
    public PiccoloTimeControlPanel() {
        ...
        buttonCanvas = new AbcLearnPCanvas();
    ...
    */
    ...
    public static class BackgroundNode extends PNode {
        ...
        private final AbcLearnPPath backgroundNode = new AbcLearnPPath( new JLabel().getBackground() );
        private final AbcLearnPPath tabNode = new AbcLearnPPath();
        private int width;
        private int height;
