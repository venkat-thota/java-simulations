...
import com.aimxcel.abclearn.common.abclearncommon.model.Bucket;
...
public class BucketView {
    ...
    public static final Font DEFAULT_LABEL_FONT = new AbcLearnFont( 18, true );
    ...
    public BucketView( Bucket bucket, ModelViewTransform mvt, Color captionColor, Font labelFont ) {
        ...
        AbcLearnPPath containerNode = new AbcLearnPPath( scaledContainerShape, containerPaint );
        ...
        Paint holePaint = new GradientPaint(
                ...
                new Point2D.Double( scaledHoleShape.getBounds2D().getMaxX(), scaledHoleShape.getBounds2D().getCenterY() ),
                Color.LIGHT_GRAY );
        AbcLearnPPath holeNode = new AbcLearnPPath( scaledHoleShape, holePaint, new BasicStroke( 1f ), Color.GRAY );
