...
import com.aimxcel.abclearn.common.aimxcelcommon.math.DampedMassSpringSystem;
...
import com.aimxcel.abclearn.core.aimxcelcore.nodes.PointSensor;
import com.aimxcel.abclearn.core.aimxcelcore.nodes.SpeedometerNode;
import com.aimxcel.abclearn.core.aimxcelcore.nodes.SpeedometerSensorNode;
...
//        tab.getModel().debugPing.updateListeners( getSensorModelPosition() );
    ...
    public static class DensitySensorNode2D extends SpeedometerSensorNode {
        ...
        public void setDensity( double density, double timeElapsed ) {
            ...
            AimxcelPPath ringNode = createRingNode( -bodyNode.speedToAngle( wrappedDensity ) );
            ...
            for ( int i = 0; i < overflowQuantity; i++ ) {
                ...
                extraHolderNode.addChild( new SpeedometerNode( "", 100, new Property<Option<Double>>( new Some<Double>( (double) MAX_SPEEDOMETER_DENSITY ) ), MAX_SPEEDOMETER_DENSITY ) {{
                    ...
                    addChild( new AimxcelPPath( new Arc2D.Double( centerX - radius, centerY - radius, // center
                                                               radius * 2, radius * 2,
        ...
        private AimxcelPPath createRingNode( final double angle ) {
            final double minAngle = -bodyNode.speedToAngle( 0 );
            ...
            return new AimxcelPPath( new Area( new Ellipse2D.Double( ringOffset, ringOffset, 100 - ringOffset * 2, 100 - ringOffset * 2 ) ) {{
    ...
    public static void main( String[] args ) {
        ...
        frame.setContentPane( new PCanvas() {{
            ...
            getLayer().addChild( new PNode() {{
                ...
                // axes
                addChild( new AimxcelPPath( new Line2D.Double( -512, 0, 512, 0 ), Color.BLACK, new BasicStroke( 1 ), Color.BLACK ) );
                addChild( new AimxcelPPath( new Line2D.Double( 0, 512, 0, -512 ), Color.BLACK, new BasicStroke( 1 ), Color.BLACK ) );

                // position in black
                for ( int i = -512; i < 512; i++ ) {
                    addChild( new AimxcelPPath( new Line2D.Double(
