...
import com.aimxcel.abclearn.platetectonics.PlateTectonicsApplication;
...
import com.aimxcel.abclearn.platetectonics.PlateTectonicsSimSharing.ParameterKeys;
...
import com.aimxcel.abclearn.platetectonics.control.CrustChooserPanel;
import com.aimxcel.abclearn.platetectonics.control.CrustPieceNode;
import com.aimxcel.abclearn.platetectonics.control.MotionTypeChooserPanel;
import com.aimxcel.abclearn.platetectonics.control.PlayModePanel;
import com.aimxcel.abclearn.platetectonics.control.ResetPanel;
import com.aimxcel.abclearn.platetectonics.control.TectonicsTimeControl;
import com.aimxcel.abclearn.platetectonics.control.ViewOptionsPanel;
import com.aimxcel.abclearn.platetectonics.model.Handle;
...
import com.aimxcel.abclearn.platetectonics.util.MortalUpdateListener;
import com.aimxcel.abclearn.platetectonics.util.Side;
import com.aimxcel.abclearn.platetectonics.view.BoxHighlightNode;
import com.aimxcel.abclearn.platetectonics.view.HandleNode;
import com.aimxcel.abclearn.platetectonics.view.PlateMotionView;
import com.aimxcel.abclearn.platetectonics.view.labels.RangeLabelNode;
import com.aimxcel.abclearn.platetectonics.view.labels.TextLabelNode;
...
public class PlateMotionTab extends PlateTectonicsTab {
    ...
    private OrthoCoreNode crustChooserNode;
    ...
    private final List<OrthoCoreNode> placedPieces = new ArrayList<OrthoCoreNode>();

    // in auto mode, the user can choose what type of motion to follow
    private OrthoCoreNode motionTypeChooserPanel = null;
...
//        model = new AnimatedPlateModel( grid );
        ...
        *----------------------------------------------------------------------------*/
         ...
         *----------------------------------------------------------------------------*/
        final OrthoCoreNode modeSwitchPanel = new OrthoCoreNode( new ControlPanelNode( new PlayModePanel( isAutoMode ) ), this, getCanvasTransform(), new Property<Vector2D>( new Vector2D( 10, 10 ) ), mouseEventNotifier ) {{
        ...
        crustChooserNode = new OrthoCoreNode( new ControlPanelNode( crustChooserPanel ), this, getCanvasTransform(),
        ...
        *----------------------------------------------------------------------------*/
        final OrthoCoreNode viewPanelNode = new OrthoCoreNode(
        ...
        *----------------------------------------------------------------------------*/
        ...
        final OrthoCoreNode timeControlPanelNode = new OrthoCoreNode( new ZeroOffsetNode( new ControlPanelNode( tectonicsTimeControl ) ), this, getCanvasTransform(),
                                                                            new Property<Vector2D>( new Vector2D() ), mouseEventNotifier ) {{
        ...
        SimpleObserver motionTypeChooserObserver = new SimpleObserver() {
            public void update() {
                ...
                if ( shouldShow && motionTypeChooserPanel == null ) {
                    ...
                    motionTypeChooserPanel = new OrthoCoreNode( new ControlPanelNode( new MotionTypeChooserPanel( getPlateMotionModel() ) ),
...
//                        double right = timeControlPanelNode.position.get().getX();
    ...
    private void manualHandleDragTimeChange( float timeChange ) {
        ...
        if ( !Float.isNaN( timeChange ) ) {
            SimSharingManager.sendUserMessage( UserComponents.handle, UserComponentTypes.sprite, com.aimxcel.abclearn.common.aimxcelcommon.simsharing.messages.UserActions.drag,
    ...
    @Override public void droppedCrustPiece( OrthoCoreNode crustPieceNode ) {
    ...
    public void resetAll() {
        ...
        for ( OrthoCoreNode placedPiece : placedPieces ) {
            // add in to the front
    ...
    private class CrustPieceGLNode extends OrthoCoreNode {
