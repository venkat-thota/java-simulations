    ...
    public static void showMacJava7Warning( final Frame parentFrame ) {
...

		{
...

			{
				...
				{
                    ImageIcon imageIcon = new ImageIcon( AimxcelCommonResources.getInstance().getImage( AimxcelCommonResources.IMAGE_AIMXCEL_LOGO ) );
					...
					{
                         add( new JLabel( AimxcelCommonResources.getString( "Jme.thisSimulationWasUnableToStart" ) ) {/**
							 * 
							 */
							private static final long serialVersionUID = 1L;

						{
                         ...
                         String body = AimxcelCommonResources.getString( "Lwjgl.macJava17Message" );
						...
						{
                            add( new JButton( AimxcelCommonResources.getString( "Common.choice.ok" ) ) {/**
								 * 
								 */
								private static final long serialVersionUID = 1L;
...

				{
...

					{
...

						{
                            ...
                            add( new JButton( AimxcelCommonResources.getString( "Jme.copyThisToTheClipboard" ) ) {/**
								 * 
								 */
								private static final long serialVersionUID = 1L;
...
//                AimxcelOptionPane.showMessageDialog( getParentFrame(), text );
            }
        } );
    }
