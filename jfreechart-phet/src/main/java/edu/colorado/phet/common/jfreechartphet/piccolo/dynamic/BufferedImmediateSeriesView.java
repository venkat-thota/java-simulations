...
//        bounds=b;
        ...
        getDynamicJFreeChartNode().getAbcLearnPCanvas().paintImmediately( new Rectangle( (int) bounds.getX(), (int) bounds.getY(), (int) ( bounds.getWidth() + 1 ), (int) ( bounds.getHeight() + 1 ) ) );
    }
}
