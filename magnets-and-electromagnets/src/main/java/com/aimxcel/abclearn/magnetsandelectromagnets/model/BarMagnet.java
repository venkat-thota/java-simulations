    ...
    private static class Grid {
        ...
        */
        private double[][] readComponent( String resourceName, Dimension size ) {
            ...
            try {
                InputStream is = MagnetsAndElectromagnetsResources.getResourceLoader().getResourceAsStream( resourceName );
            ...
            if ( errorString != null ) {
                String message = MessageFormat.format( MagnetsAndElectromagnetsStrings.ERROR_BAR_MAGNET_INITIALIZATION, errorString );
