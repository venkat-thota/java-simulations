...
public abstract class NeedleColorStrategy {
    ...
    protected static final Color NORTH_COLOR = MagnetsAndElectromagnetsConstants.NORTH_COLOR;
    protected static final Color SOUTH_COLOR = MagnetsAndElectromagnetsConstants.SOUTH_COLOR;
