...
public class MagnetsAndElectromagnetsObservable extends SimpleObservable {
     ...
     */
    public MagnetsAndElectromagnetsObservable() {
     ...
     */
    public MagnetsAndElectromagnetsObservable( Point2D location, double direction ) {
        super();
