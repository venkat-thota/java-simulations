...
import com.aimxcel.abclearn.magnetsandelectromagnets.model.AbstractCoil;
...
public class CoilGraphic implements SimpleObserver {
    ...
    private double calculateElectronSpeed() {
        ...
        if ( Math.abs( currentAmplitude ) < MagnetsAndElectromagnetsConstants.CURRENT_AMPLITUDE_THRESHOLD ) {
            currentAmplitude = 0;
        }
