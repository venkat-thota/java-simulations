...
import com.aimxcel.abclearn.magnetsandelectromagnets.model.Electron;
...
public class ElectronGraphic extends AimxcelImageGraphic implements SimpleObserver {
    ...
    public ElectronGraphic( Component component, CompositeAimxcelGraphic parent, Electron electronModel ) {
        ...
        _foregroundImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.ELECTRON_FOREGROUND_IMAGE );
        _backgroundImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.ELECTRON_BACKGROUND_IMAGE );
