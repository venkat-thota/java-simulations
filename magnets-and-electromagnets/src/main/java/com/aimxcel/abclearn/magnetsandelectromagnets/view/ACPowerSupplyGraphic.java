...
public class ACPowerSupplyGraphic extends GraphicLayerSet implements SimpleObserver {
    ...
    private MagnetsAndElectromagnetsSlider _maxAmplitudeSlider;
    private MagnetsAndElectromagnetsSlider _frequencySlider;
    ...
    public ACPowerSupplyGraphic( Component component, ACPowerSupply acPowerSupplyModel ) {
        ...
        {
            _maxAmplitudeSlider = new MagnetsAndElectromagnetsSlider( qualifiedUserComponent( Components.maxAmplitudeSlider ), component, 100 /* track length */ );

            _maxAmplitudeSlider.setMinimum( (int) ( 100.0 * MagnetsAndElectromagnetsConstants.AC_MAXAMPLITUDE_MIN ) );
            _maxAmplitudeSlider.setMaximum( (int) ( 100.0 * MagnetsAndElectromagnetsConstants.AC_MAXAMPLITUDE_MAX ) );
        ...
        // Frequency slider
        {
            _frequencySlider = new MagnetsAndElectromagnetsSlider( qualifiedUserComponent( Components.frequencySlider ), component, 100 /* track length */ );

            _frequencySlider.setMinimum( (int) ( 100.0 * MagnetsAndElectromagnetsConstants.AC_FREQUENCY_MIN ) );
            _frequencySlider.setMaximum( (int) ( 100.0 * MagnetsAndElectromagnetsConstants.AC_FREQUENCY_MAX ) );
        ...
        // Sine Wave
        {
            ...
            _waveGraphic.setMaxCycles( MagnetsAndElectromagnetsConstants.AC_FREQUENCY_MAX / MagnetsAndElectromagnetsConstants.AC_FREQUENCY_MIN );
...
//                          "  amplitude=" + _acPowerSupplyModel.getAmplitude() * 100 + "%" );
    ...
    private static class BackgroundGraphic extends AimxcelImageGraphic {
        ...
        public BackgroundGraphic( Component component ) {
            ...
            // AC panel
            BufferedImage powerSupplyImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.AC_POWER_SUPPLY_IMAGE );
            AimxcelImageGraphic panel = new AimxcelImageGraphic( component, powerSupplyImage );
            graphicLayerSet.addGraphic( panel, PANEL_LAYER );

            // Title label
            {
                AimxcelTextGraphic title = new AimxcelTextGraphic( component, TITLE_FONT, MagnetsAndElectromagnetsStrings.TITLE_AC_POWER_SUPPLY, TITLE_COLOR );
