...
import com.aimxcel.abclearn.magnetsandelectromagnets.control.panel.MagnetsAndElectromagnetsPanel;
...
public class GridControlsDialog extends PaintImmediateDialog implements ActionListener, ChangeListener {
    ...
    public GridControlsDialog( AimxcelApplication app ) {
        ...
        super.setTitle( MagnetsAndElectromagnetsStrings.TITLE_GRID_CONTROLS );
    ...
    private JPanel createInputPanel() {
        ...
        // Warning panel
        JLabel warningMessage = new JLabel( MagnetsAndElectromagnetsStrings.LABEL_GRID_CONTROLS_WARNING );
        JPanel warningPanel = new JPanel();
        warningPanel.setBorder( new EmptyBorder( 10, 10, 10, 10 ) );
        warningPanel.add( warningMessage );

        // Grid spacing
        JLabel spacingLabel = new JLabel( MagnetsAndElectromagnetsStrings.LABEL_NEEDLE_SPACING );
        {
            // Slider
            _spacingSlider = new SimSharingJSlider( qualifiedUserComponent( Components.needleSpacingSlider ) );
            _spacingSlider.setMinimum( MagnetsAndElectromagnetsConstants.GRID_SPACING_MIN );
            _spacingSlider.setMaximum( MagnetsAndElectromagnetsConstants.GRID_SPACING_MAX );
            _spacingSlider.setValue( _xSpacing );
            _spacingSlider.setPreferredSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
            _spacingSlider.setMaximumSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
            _spacingSlider.setMinimumSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
        ...
        // Needle size
        JLabel needleSizeLabel = new JLabel( MagnetsAndElectromagnetsStrings.LABEL_NEEDLE_SIZE );
        {
            // Slider
            _needleSizeSlider = new SimSharingJSlider( qualifiedUserComponent( Components.needleSizeSlider ) );
            _needleSizeSlider.setMinimum( MagnetsAndElectromagnetsConstants.GRID_NEEDLE_WIDTH_MIN );
            _needleSizeSlider.setMaximum( MagnetsAndElectromagnetsConstants.GRID_NEEDLE_WIDTH_MAX );
            _needleSizeSlider.setValue( _needleSize.width );
            _needleSizeSlider.setPreferredSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
            _needleSizeSlider.setMaximumSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
            _needleSizeSlider.setMinimumSize( MagnetsAndElectromagnetsPanel.SLIDER_SIZE );
    ...
    private JPanel createActionsPanel() {
        _okButton = new SimSharingJButton( qualifiedUserComponent( Components.okButton ), MagnetsAndElectromagnetsStrings.BUTTON_OK );
        _okButton.addActionListener( this );

        _cancelButton = new SimSharingJButton( qualifiedUserComponent( Components.cancelButton ), MagnetsAndElectromagnetsStrings.BUTTON_CANCEL );
    ...
    public void stateChanged( ChangeEvent e ) {
        ...
        int needleHeight = (int) ( needleWidth / MagnetsAndElectromagnetsConstants.GRID_NEEDLE_ASPECT_RATIO );
