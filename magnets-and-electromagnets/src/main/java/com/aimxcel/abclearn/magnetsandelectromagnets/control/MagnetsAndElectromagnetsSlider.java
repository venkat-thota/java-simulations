...
public class MagnetsAndElectromagnetsSlider extends GraphicSlider {
     ...
     */
    public MagnetsAndElectromagnetsSlider( IUserComponent userComponent, Component component, int trackLength ) {
     ...
     */
    public MagnetsAndElectromagnetsSlider( IUserComponent userComponent, Component component, int trackLength, int trackWidth, Color trackColor ) {
        ...
        // Knob
        BufferedImage knobImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.SLIDER_KNOB_IMAGE );
        AimxcelGraphic knob = new AimxcelImageGraphic( component, knobImage );
        knob.centerRegistrationPoint();
        setKnob( knob );

        // Knob Highlight
        BufferedImage knobHighlightImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.SLIDER_KNOB_HIGHLIGHT_IMAGE );
