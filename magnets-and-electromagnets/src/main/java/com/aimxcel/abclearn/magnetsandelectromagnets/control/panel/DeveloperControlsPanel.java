...
public class DeveloperControlsPanel extends MagnetsAndElectromagnetsPanel {
    ...
    public DeveloperControlsPanel( 
        ...
        if ( bFieldInsideGraphic != null || bFieldOutsideGraphic != null ) {
            double min = MagnetsAndElectromagnetsConstants.GRID_INTENSITY_SCALE_MIN;
            double max = MagnetsAndElectromagnetsConstants.GRID_INTENSITY_SCALE_MAX;
        ...
        if ( pickupCoilModel != null ) {
            double min = MagnetsAndElectromagnetsConstants.PICKUP_CALIBRATION_EMF_MIN;
            double max = MagnetsAndElectromagnetsConstants.PICKUP_CALIBRATION_EMF_MAX;
        ...
        if ( pickupCoilGraphic != null ) {
            double min = MagnetsAndElectromagnetsConstants.PICKUP_ELECTRONS_SPEED_SCALE_MIN;
            double max = MagnetsAndElectromagnetsConstants.PICKUP_ELECTRONS_SPEED_SCALE_MAX;
        ...
        if ( pickupCoilModel != null ) {
            double min = MagnetsAndElectromagnetsConstants.PICKUP_TRANSITION_SMOOTHING_SCALE_MIN;
            double max = MagnetsAndElectromagnetsConstants.PICKUP_TRANSITION_SMOOTHING_SCALE_MAX;
        ...
        if ( lightbulbGraphic != null ) {
            double min = MagnetsAndElectromagnetsConstants.LIGHTBULB_GLASS_GLOW_SCALE_MIN;
            double max = MagnetsAndElectromagnetsConstants.LIGHTBULB_GLASS_GLOW_SCALE_MAX;
