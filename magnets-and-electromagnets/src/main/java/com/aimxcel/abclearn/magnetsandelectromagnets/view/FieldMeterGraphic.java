...
public class FieldMeterGraphic extends CompositeAimxcelGraphic
    ...
    public FieldMeterGraphic( Component component, FieldMeter fieldMeterModel ) {
        ...
        BufferedImage fieldMeterImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.FIELD_METER_IMAGE );
        ...
        AimxcelTextGraphic titleText = new AimxcelTextGraphic( component, TITLE_FONT, MagnetsAndElectromagnetsStrings.TITLE_FIELD_METER, TITLE_COLOR, 0, 0 );
        ...
        // Setup interactivity.
        _mouseHandler = new MagnetsAndElectromagnetsMouseHandler( Components.fieldMeter, UserComponentTypes.sprite, _fieldMeterModel, this );
        super.setCursorHand();
