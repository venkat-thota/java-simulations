...
public class VoltmeterGraphic extends CompositeAimxcelGraphic implements SimpleObserver {
    ...
    private static class BackgroundGraphic extends AimxcelImageGraphic {
        ...
        public BackgroundGraphic( Component component ) {
            ...
            // Meter body
            BufferedImage voltMeterImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.VOLTMETER_IMAGE );
            AimxcelImageGraphic body = new AimxcelImageGraphic( component, voltMeterImage );
            graphicLayerSet.addGraphic( body, BODY_LAYER );
            
            // Title label
            {
                AimxcelTextGraphic title = new AimxcelTextGraphic( component, TITLE_FONT, MagnetsAndElectromagnetsStrings.TITLE_VOLTMETER, TITLE_COLOR );
            ...
            // Resistor
            BufferedImage resistorImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.RESISTOR_IMAGE );
            ...
            // Probes
            {
                ...
                BufferedImage leftProbeImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.VOLTMETER_PROBE_WHITE_IMAGE );
                ...
                BufferedImage rightProbeImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.VOLTMETER_PROBE_BLACK_IMAGE );
