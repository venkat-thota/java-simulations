...
public class PickupCoil extends AbstractCoil implements ModelElement, SimpleObserver {
    ...
    */
     ...
     * Calculates the induced emf using MagnetsAndElectromagnets's Law.
     *
     * @param dt time delta
     */
    ...
    /**
     * Updates the induced emf (and other related instance data), using MagnetsAndElectromagnets's Law.
     */
    ...
    */
    private double getEffectiveLoopArea() {
        double width = MagnetsAndElectromagnetsConstants.MIN_PICKUP_LOOP_RADIUS;
