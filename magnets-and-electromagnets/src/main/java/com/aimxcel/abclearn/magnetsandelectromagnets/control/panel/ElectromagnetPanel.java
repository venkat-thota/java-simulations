...
public class ElectromagnetPanel extends MagnetsAndElectromagnetsPanel {
    ...
    public ElectromagnetPanel(
        ...
        TitledBorder titledBorder = BorderFactory.createTitledBorder( border, MagnetsAndElectromagnetsStrings.TITLE_ELECTROMAGNET_PANEL );
        ...
        JPanel loopsPanel = new JPanel();
        {
            ...
            spinnerModel.setMaximum( new Integer( MagnetsAndElectromagnetsConstants.ELECTROMAGNET_LOOPS_MAX ) );
            spinnerModel.setMinimum( new Integer( MagnetsAndElectromagnetsConstants.ELECTROMAGNET_LOOPS_MIN ) );
            spinnerModel.setValue( new Integer( MagnetsAndElectromagnetsConstants.ELECTROMAGNET_LOOPS_MIN ) );
        ...
        {
            // Title
            TitledBorder indicatorBorder = new TitledBorder( MagnetsAndElectromagnetsStrings.TITLE_CURRENT_SOURCE );
            ...
            ImageIcon batteryIcon = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.BATTERY_ICON ) );
            ImageIcon batteryIconSelected = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.BATTERY_ICON_SELECTED ) );
            _batteryRadioButton = new SimSharingJRadioButton( qualifyUserComponent( Components.dcRadioButton ), MagnetsAndElectromagnetsStrings.RADIO_BUTTON_DC, batteryIcon );
            ...
            ImageIcon acIcon = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.AC_POWER_SUPPLY_ICON ) );
            ImageIcon acIconSelected = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.AC_POWER_SUPPLY_ICON_SELECTED ) );
            _acRadioButton = new SimSharingJRadioButton( qualifyUserComponent( Components.acRadioButton ), MagnetsAndElectromagnetsStrings.RADIO_BUTTON_AC, acIcon );
