...
import com.aimxcel.abclearn.magnetsandelectromagnets.control.panel.BarMagnetPanel;
...
import com.aimxcel.abclearn.magnetsandelectromagnets.view.BarMagnetGraphic;
...
public class BarMagnetModule extends MagnetsAndElectromagnetsModule {
    ...
    private static final double BAR_MAGNET_STRENGTH = 0.75 * MagnetsAndElectromagnetsConstants.BAR_MAGNET_STRENGTH_MAX;
    ...
    public BarMagnetModule( boolean wiggleMeEnabled ) {
        ...
        super( Components.barMagnetTab, MagnetsAndElectromagnetsStrings.TITLE_BAR_MAGNET_MODULE );
        ...
        _barMagnetModel.setMaxStrength( MagnetsAndElectromagnetsConstants.BAR_MAGNET_STRENGTH_MAX );
        _barMagnetModel.setMinStrength( MagnetsAndElectromagnetsConstants.BAR_MAGNET_STRENGTH_MIN );
        ...
        _bFieldInsideGraphic.setNeedleSize( MagnetsAndElectromagnetsConstants.GRID_NEEDLE_SIZE );
        apparatusPanel.addGraphic( _bFieldInsideGraphic, BAR_MAGNET_LAYER );

        // B-field outside the magnet
        _bFieldOutsideGraphic = new BFieldOutsideGraphic( apparatusPanel, _barMagnetModel, MagnetsAndElectromagnetsConstants.GRID_SPACING, MagnetsAndElectromagnetsConstants.GRID_SPACING );
    ...
    private static class ThisWiggleMeGraphic extends WiggleMeGraphic implements SimpleObserver {
        ...
        public ThisWiggleMeGraphic( Component component, BaseModel model, BarMagnet barMagnetModel, Compass compassModel ) {
            ...
            setText( MagnetsAndElectromagnetsStrings.WIGGLEME_BAR_MAGNET );
