...
import com.aimxcel.abclearn.magnetsandelectromagnets.MagnetsAndElectromagnetsSimSharing;
...
public class TurbineGraphic extends GraphicLayerSet implements SimpleObserver, ApparatusPanel2.ChangeListener {
    ...
    private MagnetsAndElectromagnetsSlider _flowSlider;
    ...
    public TurbineGraphic( Component component, Turbine turbineModel ) {
        ...
        // Faucet 
        {
            BufferedImage faucetImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.FAUCET_IMAGE );
        ...
        // Water Flow slider
        {
            _flowSlider = new MagnetsAndElectromagnetsSlider( Components.faucetSlider, component, 70 );
        ...
        // Water Wheel
        {
            BufferedImage waterWheelImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.WATER_WHEEL_IMAGE );
            ...
            _waterWheelGraphic.addMouseInputListener( new NonInteractiveEventListener( MagnetsAndElectromagnetsSimSharing.Components.waterWheel ) );
            addGraphic( _waterWheelGraphic, WATER_WHEEL_LAYER );
        }

        // Bar magnet
        {
            BufferedImage barMagnetImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.BAR_MAGNET_IMAGE );
        ...
        // Pivot point
        {
            BufferedImage turbinePivotImage = MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.TURBINE_PIVOT_IMAGE );
        ...
        // RPM readout
        {
            ...
            AimxcelTextGraphic rpmUnits = new AimxcelTextGraphic( component, RPM_UNITS_FONT, MagnetsAndElectromagnetsStrings.UNITS_RPM, RPM_COLOR );
