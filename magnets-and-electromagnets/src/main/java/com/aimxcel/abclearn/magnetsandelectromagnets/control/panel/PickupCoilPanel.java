...
import com.aimxcel.abclearn.magnetsandelectromagnets.view.CoilGraphic;
...
public class PickupCoilPanel extends MagnetsAndElectromagnetsPanel {
    ...
    public PickupCoilPanel(
        ...
        TitledBorder titleBorder = BorderFactory.createTitledBorder( lineBorder, MagnetsAndElectromagnetsStrings.TITLE_PICKUP_COIL_PANEL );
        ...
        {
            // Title
            TitledBorder indicatorBorder = new TitledBorder( MagnetsAndElectromagnetsStrings.TITLE_INDICATOR );
            ...
            ImageIcon lightbulbIcon = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.LIGHTBULB_ICON ) );
            ImageIcon lightbulbIconSelected = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.LIGHTBULB_ICON_SELECTED ) );
            ...
            ImageIcon voltmeterIcon = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.VOLTMETER_ICON ) );
            ImageIcon voltmeterIconSelected = new ImageIcon( MagnetsAndElectromagnetsResources.getImage( MagnetsAndElectromagnetsConstants.VOLTMETER_ICON_SELECTED ) );
        ...
        {
            JLabel loopsLabel = new JLabel( MagnetsAndElectromagnetsStrings.LABEL_NUMBER_OF_LOOPS );

            // Spinner, keyboard editing disabled.
            SpinnerNumberModel spinnerModel = new SpinnerNumberModel();
            spinnerModel.setMaximum( new Integer( MagnetsAndElectromagnetsConstants.MAX_PICKUP_LOOPS ) );
            spinnerModel.setMinimum( new Integer( MagnetsAndElectromagnetsConstants.MIN_PICKUP_LOOPS ) );
            spinnerModel.setValue( new Integer( MagnetsAndElectromagnetsConstants.MIN_PICKUP_LOOPS ) );
        ...
        // Loop area
        {
            ...
            int max = 100;
            int min = (int) ( 100.0 * MagnetsAndElectromagnetsConstants.MIN_PICKUP_LOOP_AREA / MagnetsAndElectromagnetsConstants.MAX_PICKUP_LOOP_AREA );

            // Slider
            _areaControl = new SimSharingLinearValueControl( qualifyUserComponent( Components.loopAreaControl ), min, max, MagnetsAndElectromagnetsStrings.LABEL_LOOP_AREA, "0", "%" );
        ...
        // Electrons on/off
        _electronsCheckBox = new SimSharingJCheckBox( qualifyUserComponent( Components.showElectrons ), MagnetsAndElectromagnetsStrings.CHECK_BOX_SHOW_ELECTRONS );
    ...
    public void update() {
        ...
        _areaControl.setValue( (int) ( 100.0 * _pickupCoilModel.getLoopArea() / MagnetsAndElectromagnetsConstants.MAX_PICKUP_LOOP_AREA ) );
    ...
    private class EventListener implements ActionListener, ChangeListener {
        ...
        public void stateChanged( ChangeEvent e ) {
            if ( e.getSource() == _areaControl ) {
                ...
                // Update the model.
                double area = ( percent / 100.0 ) * MagnetsAndElectromagnetsConstants.MAX_PICKUP_LOOP_AREA;
