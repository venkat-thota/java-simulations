...
public class MagnetsAndElectromagnetsConstants {
   
    // Not intended for instantiation.
    private MagnetsAndElectromagnetsConstants() {}
    ...
    public static final String PROJECT_NAME = "magnets-and-electromagnets";
    
    public static final String FLAVOR_FARADAY = "magnets-and-electromagnets";
    ...
    public static final int CLOCK_DELAY = ( 1000 / MagnetsAndElectromagnetsConstants.CLOCK_FRAME_RATE ); // milliseconds
