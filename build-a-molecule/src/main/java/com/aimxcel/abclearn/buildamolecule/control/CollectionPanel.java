...
import com.aimxcel.abclearn.buildamolecule.control.GeneralLayoutNode.CompositeLayoutMethod;
import com.aimxcel.abclearn.buildamolecule.control.GeneralLayoutNode.HorizontalAlignMethod;
import com.aimxcel.abclearn.buildamolecule.control.GeneralLayoutNode.LayoutMethod;
import com.aimxcel.abclearn.buildamolecule.control.GeneralLayoutNode.VerticalLayoutMethod;
...
import com.aimxcel.abclearn.buildamolecule.model.CollectionList.Listener;
...
import com.aimxcel.abclearn.core.aimxcelcore.AimxcelRootPNode;
...
public class CollectionPanel extends PNode {
    ...
    private boolean hasCanvasAsParent() {
        ...
        while ( node.getParent() != null ) {
            node = node.getParent();
            if ( node instanceof AimxcelRootPNode ) {
                return true;
            }
        }
        return false;
