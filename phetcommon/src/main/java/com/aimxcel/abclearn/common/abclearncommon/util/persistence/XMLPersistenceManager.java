...
package com.aimxcel.abclearn.common.abclearncommon.util.persistence;
...
public class XMLPersistenceManager {
    ...
    private static final String SAVE_TITLE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.title" );
    private static final String SAVE_CONFIRM_MESSAGE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.confirm.message" );
    private static final String SAVE_ERROR_MESSAGE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.error.message" );
    private static final String SAVE_ERROR_ENCODE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.save.error.encode" );

    private static final String LOAD_TITLE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.title" );
    private static final String LOAD_ERROR_MESSAGE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.message" );
    private static final String LOAD_ERROR_DECODE = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.decode" );
    private static final String LOAD_ERROR_CONTENTS = AbcLearnCommonResources.getInstance().getLocalizedString( "XMLPersistenceManager.load.error.contents" );
    ...
    private static abstract class AbstractObjectSaveLoadStrategy implements ISaveLoadStrategy {
        ...
        */
        protected void showError( String format, String errorMessage ) {
            ...
            AbcLearnOptionPane.showErrorDialog( _parentFrame, message );
        }
    }
        ...
        public void save( Object object ) {
            ...
            try {
                ...
                if ( selectedFile.exists() ) {
                    String title = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.title.confirm" );
                    int reply = AbcLearnOptionPane.showYesNoDialog( getParentFrame(), SAVE_CONFIRM_MESSAGE, title );
