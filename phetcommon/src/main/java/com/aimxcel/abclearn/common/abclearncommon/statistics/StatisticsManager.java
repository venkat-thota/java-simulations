...
import com.aimxcel.abclearn.common.abclearncommon.application.SoftwareAgreementManager;
...
public class StatisticsManager {
    ...
    /* singleton */
    private StatisticsManager( AbcLearnApplication app ) {
        simInfo = app.getSimInfo();
        parentFrame = app.getAbcLearnFrame();
        statisticsThread.start();
    }

    public static StatisticsManager initInstance( AbcLearnApplication app ) {
        if ( instance != null ) {
