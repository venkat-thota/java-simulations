...
//import com.aimxcel.abclearn.common.abclearncommon.view.util.HTMLEditorPane;
...
public class HTMLUtils {
    ...
    private static final Font DEFAULT_FONT = new AbcLearnFont();
     ...
     * @return
     */
    public static String getAbcLearnHomeHref() {
        return getAbcLearnHomeHref( AbcLearnCommonConstants.ABC_LEARN_HOME_URL );
    }
     ...
     * @return
     */
    public static String getAbcLearnHomeHref( String text ) {
        return getHref( AbcLearnCommonConstants.ABC_LEARN_HOME_URL, text );
    }
     ...
     * @return
     */
    public static String getAbcLearnMailtoHref() {
        return getAbcLearnMailtoHref( AbcLearnCommonConstants.ABC_LEARN_EMAIL );
    }
     ...
     * @return
     */
    public static String getAbcLearnMailtoHref( String text ) {
        return getHref( "mailto:" + AbcLearnCommonConstants.ABC_LEARN_EMAIL, text );
    }
    ...
    public static String getSimWebsiteURL( String project, String sim ) {
        return AbcLearnCommonConstants.SIM_WEBSITE_REDIRECT_URL + "?" +
               "request_version=" + AbcLearnCommonConstants.SIM_WEBSITE_REDIRECT_VERSION + PHP_ARG_DELIMITER +
    ...
    public static String getSimJarURL( String project, String sim, Locale locale ) {
        String url = AbcLearnCommonConstants.SIM_JAR_REDIRECT_URL + "?" +
                     "request_version=" + AbcLearnCommonConstants.SIM_JAR_REDIRECT_VERSION + PHP_ARG_DELIMITER +
                     "project=" + project + PHP_ARG_DELIMITER +
    ...
    public static String getProjectJarURL( String project, String ampersand ) {
        return AbcLearnCommonConstants.SIM_JAR_REDIRECT_URL + "?" +
               "request_version=" + AbcLearnCommonConstants.SIM_JAR_REDIRECT_VERSION + ampersand +
               "project=" + project;
    }
