...
public class DeploymentScenario {
    ...
    // enumeration
    public static final DeploymentScenario ABC_LEARN_INSTALLATION = new DeploymentScenario( "phet-installation", true, true, true );
    public static final DeploymentScenario STANDALONE_JAR = new DeploymentScenario( "standalone-jar", true, true, true );
    public static final DeploymentScenario ABC_LEARN_PRODUCTION_WEBSITE = new DeploymentScenario( "phet-production-website", false, false, false );
    public static final DeploymentScenario ABC_LEARN_DEVELOPMENT_WEBSITE = new DeploymentScenario( "phet-development-website", false, false, false );
    ...
    */
    private static final String ABC_LEARN_PRODUCTION_CODEBASE_PREFIX = AbcLearnCommonConstants.ABC_LEARN_HOME_SERVER; // prefix!
    private static final String ABC_LEARN_DEVELOPMENT_CODEBASE_SUBSTRING = "colorado.edu"; // substring!
    ...
    */
    private static DeploymentScenario determineScenario() {
        ...
        if ( AbcLearnServiceManager.isJavaWebStart() ) {

            if ( AbcLearnInstallation.exists() ) {
                scenario = DeploymentScenario.ABC_LEARN_INSTALLATION;
            }
            else {
                ...
                if ( codeBase != null ) {
                    ...
                    if ( codebaseFragment.startsWith( ABC_LEARN_PRODUCTION_CODEBASE_PREFIX ) ) {
                        scenario = DeploymentScenario.ABC_LEARN_PRODUCTION_WEBSITE;
                    }
                    else if ( codebaseFragment.indexOf( ABC_LEARN_DEVELOPMENT_CODEBASE_SUBSTRING ) >= 0 ) {
                        /* 
                         ...
                         */
                        scenario = DeploymentScenario.ABC_LEARN_DEVELOPMENT_WEBSITE;
                    }
                    else {
