 ...
 * @author Ron LeMaster
 */
public class AbcLearnUtilities {
    ...
    public static Module getActiveModule() {
        return AbcLearnApplication.getInstance().getActiveModule();
    }

    /**
     * Returns a reference to the application's AbcLearnFrame
     *
     * @return The AbcLearnFrame
     */
    public static AbcLearnFrame getAbcLearnFrame() {
