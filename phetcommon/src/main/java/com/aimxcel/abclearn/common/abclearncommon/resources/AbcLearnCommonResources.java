...
import com.aimxcel.abclearn.common.abclearncommon.util.LocaleUtils;
...
/**
 * AbcLearnCommonResources is a singleton that provides access to phetcommon's JAR resources.
 */
public class AbcLearnCommonResources {
    ...
    public static final String IMAGE_ABC_LEARN_LOGO = "logos/phet-logo-120x50.jpg";
    ...
    private static AbcLearnResources INSTANCE = new AbcLearnResources( "phetcommon" );

    //Values for translated strings
    public static final String PICCOLO_ABC_LEARN_VELOCITY_SENSOR_NODE_SPEED = getString( "PiccoloAbcLearn.VelocitySensorNode.speed" );
    public static final String PICCOLO_ABC_LEARN_VELOCITY_SENSOR_NODE_UNKNOWN = getString( "PiccoloAbcLearn.VelocitySensorNode.unknown" );

    /* not intended for instantiation */
    private AbcLearnCommonResources() {
    }
    ...
    public static String[] getPreferredFontNames( Locale locale ) {
        ...
        try {
            fontProperties.load( AbcLearnCommonResources.getInstance().getResourceAsStream( PREFERRED_FONTS_RESOURCE ) );
