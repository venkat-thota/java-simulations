...
//import com.aimxcel.abclearn.common.abclearncommon.simsharing.components.SimSharingLogDialog;
...
public class SimSharingLogMenuItem extends SimSharingJMenuItem {
    ...
    public SimSharingLogMenuItem( final AbcLearnFrame parent ) {
                        ...
                        addActionListener( new ActionListener() {
                            public void actionPerformed( ActionEvent e ) {
                                ...
                                if ( selectedFile.exists() ) {
                                    ...
                                    int reply = AbcLearnOptionPane.showYesNoDialog( parent, message, "Confirm" );
