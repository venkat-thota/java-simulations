 ...
 * Date modified : $Date$
 */
package com.aimxcel.abclearn.common.abclearncommon.view.clock;
...
//import com.aimxcel.abclearn.common.abclearncommon.view.clock.StopwatchButtonListener;
//import com.aimxcel.abclearn.common.abclearncommon.view.clock.StopwatchClockListener;
//import com.aimxcel.abclearn.common.abclearncommon.view.clock.StopwatchEvent;
//import com.aimxcel.abclearn.common.abclearncommon.view.clock.StopwatchListener;
import com.aimxcel.abclearn.common.abclearncommon.view.clock.StopwatchPanel;
...
public class StopwatchPanel extends JPanel {
    ...
    public StopwatchPanel( IClock clock, String timeUnits, double scaleFactor, NumberFormat timeFormat ) {
        ...
        // Start/Stop button
        startString = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.start" );
        stopString = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.stop" );
        startStopButton = new JButton( startString );
        SwingUtils.fixButtonOpacity( startStopButton );

        // Reset button
        resetButton = new JButton( AbcLearnCommonResources.getInstance().getLocalizedString( "Common.StopwatchPanel.reset" ) );
