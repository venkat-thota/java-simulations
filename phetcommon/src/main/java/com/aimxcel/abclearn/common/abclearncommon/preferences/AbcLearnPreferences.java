 ...
 */
public class AbcLearnPreferences {

    // if we don't have access permissions, this file will be null 
    private static AbcLearnPreferencesFile PREFERENCES_FILE;
    ...
    static {
        try {
            PREFERENCES_FILE = new AbcLearnPreferencesFile();
        }
        catch ( AccessControlException accessControlException ) {
            PREFERENCES_FILE = null;
            System.out.println( "AbcLearnPreferences: access to local filesystem denied" );
        }
    }
     ...
     */
    private static class AbcLearnPreferencesFile extends File {
        public AbcLearnPreferencesFile() throws AccessControlException {
            super( new AbcLearnPersistenceDir(), "preferences.properties" );
        }
    ...
    /* singleton */
    private static AbcLearnPreferences instance;

    private final Properties properties = new Properties();

    /* singleton */
    private AbcLearnPreferences() {
    ...
    public static AbcLearnPreferences getInstance() {
        if ( instance == null ) {
            instance = new AbcLearnPreferences();
        }
        return instance;
    }
    ...
    */
    ...
    private void storePreferences() {
        if ( PREFERENCES_FILE != null ) {
            try {
                properties.store( new FileOutputStream( PREFERENCES_FILE ), "Preferences for PhET, see " + AbcLearnCommonConstants.ABC_LEARN_HOME_URL );
            }
            catch ( IOException e ) {
                e.printStackTrace();
            }
    ...
    public static void main( String[] args ) throws IOException {
        AbcLearnPreferences phetPreferences = new AbcLearnPreferences();
