...
import com.aimxcel.abclearn.common.abclearncommon.util.SignedIntegerFormat;
...
public class SignedIntegerFormat extends DecimalFormat {
    ...
    public SignedIntegerFormat() {
        this.decimalFormat = ( DecimalFormat.getNumberInstance( AbcLearnResources.readLocale() ) );
