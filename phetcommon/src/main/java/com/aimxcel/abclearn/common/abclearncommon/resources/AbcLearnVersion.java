...
/**
 * AbcLearnVersionInfo encapsulates a simulation's version information.
 */
public class AbcLearnVersion {
    ...
    public AbcLearnVersion( String major, String minor, String dev, String revision, String timestamp ) {
    ...
    */
    ...
    public boolean equals( Object o ) {
        ...
        AbcLearnVersion that = (AbcLearnVersion) o;
    ...
    public boolean isGreaterThan( AbcLearnVersion version ) {
    ...
    public long getTimestampSeconds() {
        ...
        try {
            ...
            System.err.println( "AbcLearnVersion.getTimestampSeconds: timestamp is invalid, ignoring: " + timestamp );
            seconds = 0;
        }
        return seconds;
    }
