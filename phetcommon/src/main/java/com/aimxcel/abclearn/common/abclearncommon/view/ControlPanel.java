...
//import com.aimxcel.abclearn.common.abclearncommon.view.ContentPanel;
import com.aimxcel.abclearn.common.abclearncommon.view.ControlPanel;
//import com.aimxcel.abclearn.common.abclearncommon.view.DefaultScrollPolicy;
...
public class ControlPanel extends JPanel {
    ...
    public JButton addResetAllButton( final Resettable[] resettables ) {
        JButton resetAllButton = new ResetAllButton( resettables, AbcLearnApplication.getInstance().getAbcLearnFrame() );
