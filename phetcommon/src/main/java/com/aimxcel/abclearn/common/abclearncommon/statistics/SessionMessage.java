...
package com.aimxcel.abclearn.common.abclearncommon.statistics;
...
import com.aimxcel.abclearn.common.abclearncommon.util.JavaVersion.JREVersion;
...
public class SessionMessage extends StatisticsMessage {
    ...
    private SessionMessage( ISimInfo simInfo ) {
        ...
        if ( DeploymentScenario.getInstance() == DeploymentScenario.ABC_LEARN_INSTALLATION ) {
            AbcLearnInstallation p = AbcLearnInstallation.getInstance();
        ...
        StatisticsMessageField[] fields = new StatisticsMessageField[] {
                ...
                new StatisticsMessageField( "Common.statistics.sim_locale_language", "sim_locale_language", AbcLearnResources.readLocale().getLanguage() ),
                new StatisticsMessageField( "Common.statistics.sim_locale_country", "sim_locale_country", AbcLearnResources.readLocale().getCountry() ),
                ...
                // User data
                new StatisticsMessageField( "Common.statistics.user_preference_file_creation_time", "user_preference_file_creation_time", AbcLearnPreferences.getInstance().getPreferencesFileCreationTime() ),
