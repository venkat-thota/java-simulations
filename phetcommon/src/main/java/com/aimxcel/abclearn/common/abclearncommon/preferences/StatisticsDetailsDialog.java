...
public class StatisticsDetailsDialog extends PaintImmediateDialog {
    ...
    private static final String TITLE = AbcLearnCommonResources.getString( "Common.statistics.details.title" );
    private static final String DESCRIPTION = AbcLearnCommonResources.getString( "Common.statistics.details.description" );
