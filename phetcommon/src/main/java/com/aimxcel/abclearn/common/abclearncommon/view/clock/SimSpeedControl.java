...
import com.aimxcel.abclearn.common.abclearncommon.view.controls.valuecontrol.SliderOnlyLayoutStrategy;
...
public class SimSpeedControl extends JPanel {
    ...
    public SimSpeedControl( double min, double max, final ConstantDtClock defaultClock ) {
        this( min, max, defaultClock, AbcLearnCommonResources.getString( "Common.sim.speed" ) );
    }
    ...
    public SimSpeedControl( double min, double max, final ConstantDtClock defaultClock, String title, final ObservableProperty<Color> textColor ) {
        ...
        table.put( new Double( min ), new TimeSpeederLabel( AbcLearnCommonResources.getString( "Common.time.slow" ), textColor ) );
        table.put( new Double( max ), new TimeSpeederLabel( AbcLearnCommonResources.getString( "Common.time.fast" ), textColor ) );
