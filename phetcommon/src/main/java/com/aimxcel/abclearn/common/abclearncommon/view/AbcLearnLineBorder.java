...
/**
 * The AbcLearnLineBorder is PhET's default border for control panel components, see #2476.
 *
 * @author Sam Reid
 */
public class AbcLearnLineBorder extends LineBorder {

    private static final int CORNER_RADIUS = 8; // radius of the rounded corners (aka arc width)

    public AbcLearnLineBorder() {
        this( Color.black );
    }

    public AbcLearnLineBorder( Color color ) {
        super( color, 1, true );
    }
