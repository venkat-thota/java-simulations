...
import com.aimxcel.abclearn.common.abclearncommon.preferences.StatisticsDetailsDialog;
...
import com.aimxcel.abclearn.common.abclearncommon.view.util.HTMLUtils.HTMLEditorPane;

//import com.aimxcel.abclearn.common.abclearncommon.application.AcceptanceDialog;
//import com.aimxcel.abclearn.common.abclearncommon.application.MessagePane;
...
public class SoftwareAgreementManager {
    ...
    public static void validate( Frame owner, SessionMessage sessionMessage ) {
        boolean alwaysAsk = AbcLearnPreferences.getInstance().isAlwaysShowSoftwareAgreement();
        int acceptedVersion = AbcLearnPreferences.getInstance().getSoftwareAgreementVersion();
    ...
    */
    ...
    private static class AcceptanceDialog extends PaintImmediateDialog {
        ...
        private static final String TITLE = AbcLearnCommonResources.getString( "Common.softwareAgreement.title" );
        private static final String ACCEPT_BUTTON = AbcLearnCommonResources.getString( "Common.softwareAgreement.accept" );
        private static final String DECLINE_BUTTON = AbcLearnCommonResources.getString( "Common.softwareAgreement.decline" );
        ...
        private void accept() {
            ...
            AbcLearnPreferences.getInstance().setSoftwareAgreementVersion( version );
            dispose();
        }
    ...
    */
    private static class MessagePane extends HTMLEditorPane {
        ...
        private static final String MESSAGE_PATTERN = AbcLearnCommonResources.getString( "Common.softwareAgreement.message" );
