...
/**
 * AbcLearnOptionPane provides JOptionPane-like functionality, but uses a PaintImmediateDialog
 ...
 */
public class AbcLearnOptionPane {

    private static final String TITLE_MESSAGE = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.title.message" );
    private static final String TITLE_CONFIRM = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.title.confirm" );
    private static final String TITLE_WARNING = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.title.warning" );
    private static final String TITLE_ERROR = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.title.error" );
    ...
    */
    ...
    public static void main( String[] args ) {
        int value = AbcLearnOptionPane.showMessageDialog( null, "message", "title" );
        System.out.println( "value=" + value );
        value = AbcLearnOptionPane.showMessageDialog( null, new JLabel( "JLabel" ), "title" );
        System.out.println( "value=" + value );
        value = AbcLearnOptionPane.showOKCancelDialog( null, "ok question", "title" );
        System.out.println( "value=" + value );
        value = AbcLearnOptionPane.showYesNoDialog( null, "yes/no question", "title" );
        System.out.println( "value=" + value );
        value = AbcLearnOptionPane.showWarningDialog( null, "warning" );
        System.out.println( "value=" + value );
        value = AbcLearnOptionPane.showErrorDialog( null, "error" );
        System.out.println( "value=" + value );
        System.exit( 0 );
    }
}
