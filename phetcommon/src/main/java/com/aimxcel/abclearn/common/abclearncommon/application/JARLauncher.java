...
import com.aimxcel.abclearn.common.abclearncommon.application.JARLauncher;
...
public class JARLauncher implements IProguardKeepClass {
    ...
    */
    ...
    private static String getTitle( Properties prop, String flavor ) {
        ...
        //the convention by AbcLearnBuildAllSimJarTask is to create project_sim style names
        if ( new StringTokenizer( flavor, "_" ).countTokens() == 2 ) {
            ...
            AbcLearnResources resources = new AbcLearnResources( project );
    ...
    */
    ...
    private static void setLocaleForOfflineJARs( Properties properties ) {
        ...
        if ( language != null ) {
            ...
            if ( !language.equals( "" ) ) {
                System.out.println( "JARLauncher: setting " + AbcLearnCommonConstants.PROPERTY_ABC_LEARN_LANGUAGE + "=" + language );
                System.setProperty( AbcLearnCommonConstants.PROPERTY_ABC_LEARN_LANGUAGE, language );
                ...
                if ( country != null ) {
                    ...
                    if ( !country.equals( "" ) ) {
                        System.out.println( "JARLauncher: setting " + AbcLearnCommonConstants.PROPERTY_ABC_LEARN_COUNTRY + "=" + country );
                        System.setProperty( AbcLearnCommonConstants.PROPERTY_ABC_LEARN_COUNTRY, country );
                    }
                }
            }
        }
    ...
    /*
    * Displays an exception using the standard abcLearn error dialog.
    */
