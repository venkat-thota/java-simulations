...
import com.aimxcel.abclearn.common.abclearncommon.math.ModelViewTransform1D;
...
//import com.aimxcel.abclearn.common.abclearncommon.view.IllegalValueException;
...
public class ModelSlider extends JPanel {
    ...
    private Font titleFont = new AbcLearnFont( Font.BOLD, 12 );
    ...
    private void relabelSlider() {
        ...
        int dMinor = SLIDER_MAX / ( numMinorTicks - 1 );
        Font labelFont = new AbcLearnFont( 0, 10 );
    ...
    public boolean testCommit() {
        try {
            ...
            String outofrange = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.OutOfRange" );
            String minimum = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Minimum" );
            String maximum = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Maximum" );
            String youentered = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.YouEntered" );
            String description = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.ModelSlider.Description" );
            AbcLearnOptionPane.showMessageDialog( this, outofrange + ".\n" + minimum + "= " + ive.getMin()
                                                    + ", " + maximum + "=" + ive.getMax() + "\n" + youentered + ": "
