...
public class HelpPanel extends JPanel {
    ...
    private String showHelpStr = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.HelpPanel.ShowHelp" );
    private String hideHelpStr = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.HelpPanel.HideHelp" );
    private String megaHelpStr = AbcLearnCommonResources.getInstance().getLocalizedString( "Common.HelpPanel.MegaHelp" );
    ...
    public HelpPanel( final Module module ) {
        ...
        miniHelpBtn.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e ) {
                ...
                AbcLearnApplication.getInstance().getAbcLearnFrame().getHelpMenu().setHelpSelected( miniHelpShowing );
            }
        } );
