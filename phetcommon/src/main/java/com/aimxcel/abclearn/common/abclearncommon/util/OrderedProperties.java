...
//import com.aimxcel.abclearn.common.abclearncommon.util.Entry;
//import com.aimxcel.abclearn.common.abclearncommon.util.ListEnumeration;
import com.aimxcel.abclearn.common.abclearncommon.util.OrderedProperties;
...
//        AbcLearnProperties phetProperties = new AbcLearnProperties( new File( "C:\\reid\\phet\\svn\\trunk\\simulations-java\\common\\phetcommon\\data\\phetcommon\\localization\\phetcommon-strings.properties" ) );
//        AbcLearnProperties phetProperties = new AbcLearnProperties( new File( "C:\\reid\\phet\\svn\\trunk\\simulations-java\\simulations\\ohm-1d\\data\\ohm-1d\\localization\\ohm-1d-strings_es.properties" ) );
//        AbcLearnProperties phetProperties = new AbcLearnProperties( new File( "C:\\reid\\phet\\svn\\trunk\\simulations-java\\simulations\\bound-states\\data\\bound-states\\localization\\bound-states-strings_es.properties" ) );
