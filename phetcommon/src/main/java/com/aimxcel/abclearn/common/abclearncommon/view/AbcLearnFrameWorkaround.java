...
/**
 * AbcLearnFrameWorkaround contains a workaround for Sun bug report 4473503
 ...
 * a paint of any lightweight components that are children of the AbcLearnFrame.
 * <p/>
 * Sample usage:
 * <p/>
 * <code><blockquote><pre>
 * public class MyApplication extends AbcLearnApplication {
 *     //....
 ...
 * <li>AbcLearnFrame.paint() is only called a few times in a few sample
 ...
 * @version $Revision$
 */
public class AbcLearnFrameWorkaround extends AbcLearnFrame {

    public AbcLearnFrameWorkaround( AbcLearnApplication application ) throws HeadlessException {
        super( application );
    }
