...
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.UserComponents.resetAllButton;
...
import com.aimxcel.abclearn.common.abclearncommon.view.ResetAllDelegate;
...
public class ResetAllButton extends SimSharingJButton {
    ...
    public ResetAllButton( final Resettable[] resettables, final Component parent ) {
        super( resetAllButton, AbcLearnCommonResources.getInstance().getLocalizedString( AbcLearnCommonResources.STRING_RESET_ALL ) );
