...
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.ParameterKeys.height;
import static com.aimxcel.abclearn.common.abclearncommon.simsharing.messages.ParameterKeys.width;
...
import com.aimxcel.abclearn.common.abclearncommon.simsharing.components.SimSharingJMenuBar;
...
import com.aimxcel.abclearn.common.abclearncommon.view.menu.DeveloperMenu;
import com.aimxcel.abclearn.common.abclearncommon.view.menu.HelpMenu;
import com.aimxcel.abclearn.common.abclearncommon.view.menu.AbcLearnFileMenu;
...
/**
 * The AbcLearnFrame is the JFrame for the AbcLearnApplication.
 *
 * @author ?
 * @version $Revision:14677 $
 */
public class AbcLearnFrame extends JFrame {
    ...
    /**
     * Constructs a AbcLearnFrame for the specified AbcLearnApplication.
     *
     * @param application the application that own the AbcLearnFrame
     */
    public AbcLearnFrame( final AbcLearnApplication application ) throws HeadlessException {
        ...
        // File menu
        defaultFileMenu = new AbcLearnFileMenu( this, application.getSimInfo() );
    ...
    private void addF8ToClearPreferencesFile() {
        ...
        getRootPane().getActionMap().put( mapKey, new AbstractAction() {
            public void actionPerformed( java.awt.event.ActionEvent e ) {
                try {
                    String path = AbcLearnPreferences.getPreferencesFile().getParentFile().getAbsolutePath();
                    System.out.println( "Preferences=" + AbcLearnPreferences.getInstance().toString() );
                    System.out.println( "Resetting preferences file." );
                    AbcLearnPreferences.clear();

                    System.out.println( "Clearing session counts." );
                    SessionCounter.getInstance().clear();
                    AbcLearnOptionPane.showMessageDialog( AbcLearnFrame.this, "Preferences file and session counts cleared, press OK to exit.\nFile is " + path + "" );
                    System.exit( 0 );
                }
                catch ( Throwable t ) {
                    t.printStackTrace();
                    System.out.println( "Could not clear preferences, t=" + t );
                    AbcLearnOptionPane.showMessageDialog( AbcLearnFrame.this, "Couldn't clear preferences, perhaps you are not running with permission to do so." );
                }
            }
        } );
    }
    ...
    /**
     * Returns the ITabbedModulePane for this AbcLearnFrame, if it has one; otherwise null.
    ...
    /**
     * Gets the AbcLearnApplication associated with this AbcLearnFrame.
     *
     * @return the AbcLearnApplication associated with this AbcLearnFrame.
     */
    public AbcLearnApplication getApplication() {
        return application;
    }
    ...
    public void removeFileMenuItem( JMenuItem menuItem ) {
        ...
        if ( testMenu != null && testMenu instanceof AbcLearnFileMenu ) {
     ...
     */
    public void setFileMenu( AbcLearnFileMenu defaultFileMenu ) {
        JMenu testMenu = getJMenuBar().getMenu( 0 );
        if ( testMenu != null && testMenu instanceof AbcLearnFileMenu ) {
            getJMenuBar().remove( testMenu );
        }
     ...
     */
    private AbcLearnFileMenu getFileMenu() {
        JMenu testMenu = getJMenuBar().getMenu( 0 );
        if ( testMenu != null && testMenu instanceof AbcLearnFileMenu ) {
            return (AbcLearnFileMenu) testMenu;
        }
        return null;
    }
    ...
    /**
     * Gets the HelpMenu for this AbcLearnFrame.
     *
     * @return the HelpMenu for this AbcLearnFrame.
     */
    ...
    public void addFileSaveLoadMenuItems() {
        ...
        JMenuItem saveItem = new SimSharingJMenuItem( chain( fileMenu, saveMenuItem ), AbcLearnCommonResources.getString( "Common.FileMenu.Save" ) );
        saveItem.setMnemonic( AbcLearnCommonResources.getChar( "Common.FileMenu.Save.mnemonic", 'S' ) );
        ...
        JMenuItem loadItem = new SimSharingJMenuItem( chain( fileMenu, loadMenuItem ), AbcLearnCommonResources.getString( "Common.FileMenu.Load" ) );
        loadItem.setMnemonic( AbcLearnCommonResources.getChar( "Common.FileMenu.Load.mnemonic", 'L' ) );
