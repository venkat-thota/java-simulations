...
/**
 * ModulePanel is the main JPanel for a Module in a AbcLearnApplication.
...
public class ModulePanel extends JPanel {
    ...
    private void activateFullScreen() {
        ...
        if ( buttonDlg == null ) {
            ...
            buttonDlg.setTitle( AbcLearnCommonResources.getInstance().getLocalizedString( "Common.BasicAbcLearnPanel.Title" ) );
            buttonDlg.setDefaultCloseOperation( JDialog.DO_NOTHING_ON_CLOSE );
            ImageIcon logo = new ImageIcon( getClass().getClassLoader().getResource( AbcLearnLookAndFeel.ABC_LEARN_LOGO_120x50 ) );
            ...
            logoButton.setToolTipText( AbcLearnCommonResources.getInstance().getLocalizedString( "Common.BasicAbcLearnPanel.LogoToolTip" ) );
