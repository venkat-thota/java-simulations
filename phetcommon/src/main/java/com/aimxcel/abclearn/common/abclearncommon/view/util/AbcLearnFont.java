...
/**
 * AbcLearnFont provides an interface for instantiating the default font used in PhET simulations.
 */
public class AbcLearnFont extends Font {
    ...
    // the font used to create instances of AbcLearnFont
    private static final Font DEFAULT_FONT = createDefaultFont();

    /**
     * Constructs a AbcLearnFont with a default style and point size.
     */
    public AbcLearnFont() {
    ...
    /**
     * Constructs a AbcLearnFont with a default style and specified point size.
     *
     * @param size the size of the font.
     */
    public AbcLearnFont( int size ) {
        this( getDefaultFontStyle(), size );
    }

    /**
     * Constructs a AbcLearnFont with a specified style and point size.
     *
     * @param style
     * @param size
     */
    public AbcLearnFont( int style, int size ) {
        super( getDefaultFontName(), style, size );
    }

    /**
     * Constructs a AbcLearnFont with a specified font size, and whether it is bold.
     *
     * @param size the font size
     * @param bold whether it is bold.
     */
    public AbcLearnFont( int size, boolean bold ) {
        this( size, bold, false );
    }

    /**
     * Constructs a AbcLearnFont font with a specified size, and whether it is bold and/or italicized.
     *
     * @param size    the font size.
     * @param bold    whether it is bold
     * @param italics whether it is italicized.
     */
    public AbcLearnFont( int size, boolean bold, boolean italics ) {
     ...
     * See #2104; other ways of solving this problem require more radical changes to AbcLearnFont.
     *
     * @return
     */
    ...
    /*
     * Creates the font that will be used to create all instances of AbcLearnFont.
     */
    private static Font createDefaultFont() {
        return getPreferredFont( AbcLearnResources.readLocale() );
    }
    ...
    public static Font getPreferredFont( Locale locale, int style, int size ) {
        ...
        String[] preferredFontNames = AbcLearnCommonResources.getPreferredFontNames( locale );
...
//                        System.out.println( "AbcLearnFont.getPreferredFont preferredFont=" + preferredFont );//XXX
                    }
                }
            }
        }
