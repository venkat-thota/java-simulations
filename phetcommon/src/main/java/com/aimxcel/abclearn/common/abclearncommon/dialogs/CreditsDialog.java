...
import com.aimxcel.abclearn.common.abclearncommon.util.AnnotationParser;
...
public class CreditsDialog extends PaintImmediateDialog {
    ...
    private static final String TITLE = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.Title" );
    private static final String CLOSE_BUTTON = AbcLearnCommonResources.getString( "Common.choice.close" );
    private static final String LICENSE_DETAILS_TITLE = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.licenseDetails" );
                ...
                public void hyperlinkUpdate( HyperlinkEvent e ) {
                    if ( e.getEventType() == HyperlinkEvent.EventType.ACTIVATED ) {
                        if ( thirdPartySoftwareCredits.isThirdPartyLicenseURL( e.getURL() ) ) {
                            ...
                            AbcLearnServiceManager.showWebPage( e.getURL() );
                        }
                    }
                }
            } );
    ...
    private static class DevelopmentTeamCredits {
        ...
        private static final String TITLE = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.AbcLearnDevelopmentTeam" );
        private static final String FILENAME = "credits.txt";

        // Localized labels to display in the credits, one label per role.
        private static final String LABEL_LEAD_DESIGN = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.lead-design" );
        private static final String LABEL_SOFTWARE_DEVELOPMENT = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.software-development" );
        private static final String LABEL_DESIGN_TEAM = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.design-team" );
        private static final String LABEL_INTERVIEWS = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.interviews" );
    ...
    private static class TranslationCredits {
        ...
        private static final String TITLE = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.TranslationCreditsTitle" );
        ...
        private String readCredits() {
            AbcLearnResources resourceLoader = new AbcLearnResources( projectName );
    ...
    private static class ThirdPartySoftwareCredits {
        ...
        private static final String TITLE = AbcLearnCommonResources.getString( "Common.About.CreditsDialog.UsesThirdPartySoftware" );
        ...
        private String readLicenseInfoFile() {
            ...
            try {
                ...
                System.err.println( getClass().getName() + ": missing  " + resourceName +
                                    " - Did you generate license info for this sim, using AbcLearnBuildGUI->Misc->Generate License Info ?" );
            }
