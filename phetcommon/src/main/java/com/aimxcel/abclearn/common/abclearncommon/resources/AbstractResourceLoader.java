...
abstract class AbstractResourceLoader implements IResourceLoader {
     ...
     */
    public AbcLearnProperties getProperties( String resourceName, final Locale locale ) {
        try {
            ...
            return new AbcLearnProperties( properties );
        }
        catch ( IOException e ) {
            e.printStackTrace();
            return new AbcLearnProperties( new Properties() );
        }
    }
