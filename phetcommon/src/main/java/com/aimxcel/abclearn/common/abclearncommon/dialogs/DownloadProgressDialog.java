...
import com.aimxcel.abclearn.common.abclearncommon.util.DownloadThread.DebugDownloadThreadListener;
import com.aimxcel.abclearn.common.abclearncommon.util.DownloadThread.DownloadThreadListener;
import com.aimxcel.abclearn.common.abclearncommon.view.MaxCharsLabel;
...
public class DownloadProgressDialog extends PaintImmediateDialog {
    ...
    public DownloadProgressDialog( Frame owner, String title, String message, DownloadThread downloader ) {
        ...
        statusLabel.setFont( new AbcLearnFont( 10 ) );

        // Cancel button
        JButton cancelButton = new JButton( AbcLearnCommonResources.getString( "Common.choice.cancel" ) );
