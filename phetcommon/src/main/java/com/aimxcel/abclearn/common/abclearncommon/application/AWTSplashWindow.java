...
public class AWTSplashWindow extends Window {
    ...
    private static final String LOGO_RESOURCE_NAME = AbcLearnLookAndFeel.ABC_LEARN_LOGO_120x50;
    ...
    public AWTSplashWindow( Frame owner, String title ) {
        ...
        // UI components
        String message = AbcLearnCommonResources.getInstance().getLocalizedString( "AbcLearnApplication.StartupDialog.message" );
...
//        textComponent = new Label( labelString );
    ...
    private Image createLabelImage( String labelString, Color background, Color foreground ) {
        AbcLearnFont font = new AbcLearnFont( 13, false );
