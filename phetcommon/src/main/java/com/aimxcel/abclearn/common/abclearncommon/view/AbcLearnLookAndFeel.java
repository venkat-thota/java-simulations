...
//import com.aimxcel.abclearn.common.abclearncommon.view.PropertyList;

/**
 * AbcLearnLookAndFeel manages the Look and Feel for a AbcLearnApplication.
 * It provides convenience methods for setting background color, fonts, etc.
 * <p/>
 * Sample subclass:
 * <code>
 * class SampleAbcLearnLookAndFeel extends AbcLearnLookAndFeel {
 * public TestAbcLearnLookAndFeelExample() {
 * setBackgroundColor( Color.blue );
 * setForegroundColor( Color.white );
 * setFont( new AbcLearnDefaultFont( Font.BOLD, 24 ) );
 * }
 * }
 * </code>
 * Sample usage:
 * <code>
 * phetApplication.setAbcLearnLookAndFeel(new SampleAbcLearnLookAndFeel());
 * </code>
 * * <p/>
 *
 * @author ?
 * @version $Revision$
 */
public class AbcLearnLookAndFeel {

    //----------------------------------------------------------------------------
    // Class data
    //----------------------------------------------------------------------------

    public static final String ABC_LEARN_LOGO_120x50 = "logos/phet-logo-120x50.jpg";
    ...
    private Font font = new AbcLearnFont();
    private Font titledBorderFont = new AbcLearnFont();
    private Font tabFont = new AbcLearnFont();
    ...
    public void setFont( Font font ) {
        if ( font == null ) { font = new AbcLearnFont(); }
    ...
    public void setTabFont( Font tabFont ) {
        if ( tabFont == null ) { tabFont = new AbcLearnFont(); }
    ...
    public void setTitledBorderFont( Font borderFont ) {
        if ( titledBorderFont == null ) { titledBorderFont = new AbcLearnFont(); }
    ...
    /**
     * Applies this AbcLearnLookAndFeel, effectively installing the resources it
    ...
    /**
     * Constructs the UIDefaults that correspond to this AbcLearnLookAndFeel,
    ...
    private Object getCommonString( String s ) {
        return AbcLearnCommonResources.getInstance().getLocalizedString( s );
    }
...
// It should not be necessary to revalidate or repaint on top of that.
    ...
    /**
     * Determines the look and feel class name that will be used by this AbcLearnLookAndFeel.
    ...
    protected String getLookAndFeelClassNamePreferOceanToWindows() {
        ...
        if ( AbcLearnUtilities.getOperatingSystem() == AbcLearnUtilities.OS_WINDOWS ) {
            if ( oldJava ) {
