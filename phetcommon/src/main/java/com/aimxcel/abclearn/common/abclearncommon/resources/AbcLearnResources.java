...
import com.aimxcel.abclearn.common.abclearncommon.resources.DefaultResourceLoader;
import com.aimxcel.abclearn.common.abclearncommon.resources.DummyConstantStringTester;
import com.aimxcel.abclearn.common.abclearncommon.resources.IResourceLoader;
...
/**
 * AbcLearnResources provides the facilities for accessing JAR resources.
 * <p/>
 ...
 * @author John De Goes
 */
public class AbcLearnResources {

    //----------------------------------------------------------------------------
    // Class data
    //----------------------------------------------------------------------------

    private static final Logger LOGGER = LoggingUtils.getLogger( AbcLearnResources.class.getCanonicalName() );
    ...
    private final AbcLearnProperties localizedProperties;
    private final AbcLearnProperties projectProperties;
    private final IResourceLoader resourceLoader;
    private final String rootDirectoryName;
    private volatile AbcLearnVersion version;
     ...
     * @param projectName
     */
    public AbcLearnResources( String projectName ) {
     ...
     */
    public AbcLearnResources( String projectName, Locale locale, IResourceLoader resourceLoader ) {
        ...
        if ( resourceLoader.exists( rootDirectoryName + PATH_SEPARATOR + projectPropertiesBundleName ) ) {
            ...
            this.projectProperties = new AbcLearnProperties();
        }
    ...
    */
    public static Locale readLocale() {
        ...
        String language = System.getProperty( AbcLearnCommonConstants.PROPERTY_ABC_LEARN_LANGUAGE );
        String country = System.getProperty( AbcLearnCommonConstants.PROPERTY_ABC_LEARN_COUNTRY ); // optional, may be null
        if ( language != null ) {
            if ( country != null ) {
                LOGGER.fine( "readLocale: overriding locale via " + AbcLearnCommonConstants.PROPERTY_ABC_LEARN_LANGUAGE + "=" + language + " " + AbcLearnCommonConstants.PROPERTY_ABC_LEARN_COUNTRY + "=" + country );
                locale = new Locale( language, country );
            }
            else {
                LOGGER.fine( "readLocale: overriding locale via " + AbcLearnCommonConstants.PROPERTY_ABC_LEARN_LANGUAGE + "=" + language );
     ...
     */
    public AbcLearnProperties getLocalizedProperties() {
     ...
     * @return AbcLearnProperties
     */
    public AbcLearnProperties getProjectProperties() {
     ...
     * @return AbcLearnProperties
     */
    public AbcLearnProperties getProperties( String resourceName ) {
     ...
     * TODO: remove duplicate implementation in AbcLearnProject
     */
    ...
    public static AbcLearnVersion getVersion( Properties properties ) {
        ...
        return new AbcLearnVersion( major, minor, dev, rev, timestamp );
    }
