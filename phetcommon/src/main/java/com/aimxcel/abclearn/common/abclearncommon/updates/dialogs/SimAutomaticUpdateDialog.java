...
public class SimAutomaticUpdateDialog extends SimAbstractUpdateDialog {
    ...
    private static final String PREFEENCES_MESSAGE = AbcLearnCommonResources.getString( "Common.updates.seePreferences" );

    private final IAskMeLaterStrategy askMeLaterStrategy;
    private final IVersionSkipper versionSkipper;

    public SimAutomaticUpdateDialog( Frame owner, ISimInfo simInfo, AbcLearnVersion newVersion, IAskMeLaterStrategy askMeLaterStrategy, IVersionSkipper versionSkipper ) {
    ...
    */
    ...
    public static void main( String[] args ) {
        ...
        AbcLearnApplicationConfig config = new AbcLearnApplicationConfig( args, "moving-man" );
        final SimAutomaticUpdateDialog dialog = new SimAutomaticUpdateDialog( new JFrame(), config, new AbcLearnVersion( "1", "00", "05", "30000", "1234567890" ), new IAskMeLaterStrategy() {
