...
import com.aimxcel.abclearn.common.abclearncommon.view.controls.valuecontrol.TestValueControls;
...
public class TestValueControls extends JFrame {
    ...
    public TestValueControls() {
        ...
        final LinearValueControl potatoControl;
        {
            ...
            Icon icon = new ImageIcon( AbcLearnCommonResources.getImage( "buttons/closeButton.png" ) );
