...
public class PrivacyPreferencesPanel extends JPanel {
    ...
    private static final String STATISTICS_ENABLED = AbcLearnCommonResources.getString( "Common.statistics.enabled" );
    ...
    public PrivacyPreferencesPanel( AbcLearnPreferences preferences, SessionMessage sessionMessage, boolean isDev ) {
    ...
    private static class DescriptionPane extends HTMLEditorPane {
        ...
        private static final String DESCRIPTION_PATTERN = AbcLearnCommonResources.getString( "Common.statistics.description" );
